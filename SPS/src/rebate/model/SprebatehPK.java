...
/**
 * The primary key class for the SPREBATEH database table.
 * 
 */
@Embeddable
public class SprebatehPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SprebatehPK)) {
			return false;
		}
		SprebatehPK castOther = (SprebatehPK)other;
		return 
