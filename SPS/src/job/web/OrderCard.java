...
public class OrderCard extends ActionSupport implements SessionAware, ParameterAware,ServletResponseAware,ServletRequestAware{
	...
	public String energize(){
		try{
			...
			if(spestcnd!=null){
				...
				spestcnd.setFinishedDate(energizeDate);
			...
			jobEjb.energizeJob(spestsea, spestcnd, spestcnt);
			execute();
		}catch(Exception ex){
	...
	public String viewOrderCardDetails()
	{
		try
		{
			...
			if(costCenterNo.equals("547.10")||costCenterNo.equals("547.20")||costCenterNo.equals("542.10")|| costCenterNo.equals("542.20") ||costCenterNo.equals("541.10")|| costCenterNo.equals("541.20") ||costCenterNo.equals("548.10")|| costCenterNo.equals("548.20"))
			{
			...
			if(pcesthmt!=null)
			{
				...
				if(listSpestcnd!=null && listSpestcnd.size()>0){
					...
					Spestcnd spestcnd = listSpestcnd.get(0);
