...
public class EstimateReferenceEjb implements EstimateReferenceEjbI{
	...
	@Override
	public void removEstimateReference( EstimateReference estimateReference, String webAppName) {
		dao.removEstimateReference(estimateReference, webAppName);
