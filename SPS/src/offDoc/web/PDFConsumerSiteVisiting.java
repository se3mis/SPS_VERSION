...
public class PDFConsumerSiteVisiting implements Printable {

	String costCenterName;
	String address;
	String applicationNumber;String customerName;
	String streeet;String phase;String appDate;String visitedDate;String session;
	...
	public String getEXPORT_REPORT_DIRECTORY() {
		return EXPORT_REPORT_DIRECTORY;
	}

	public void setEXPORT_REPORT_DIRECTORY(String eXPORT_REPORT_DIRECTORY) {
		EXPORT_REPORT_DIRECTORY = eXPORT_REPORT_DIRECTORY;
	}

	public PDFConsumerSiteVisiting(String costCenterName,String costCenterArea,
			String address,String applicationNumber,String customerName,
			String street,String  suberb,String city,String postalCode,String phase,String appDate,String visitedDate,String session)
	{
	...
	throws PrinterException {
		...
		y = y + d * 2;
		line ="This refers to your application dated " + this.appDate + " on the above matter. An officer will be visiting to the said premises on " + this.visitedDate + " in the " + this.session + " session to prepare the estimate in order to provide the requested power supply. ";
		...
		y = y + d*2 ;	
		line = "My officers will require to inspect the said premises , therefore you (or responsible person ) are kindly requested to availlable at the said premises";
		rest = printLine( ft, line, x,y,99,90);
		while (rest != "") {
			y = y + 15;
			rest = printLine( ft, rest, x,y,99,90);
	...
	public void Printx()
	{
		...
		Book book = new Book();	
		book.append(new PDFConsumerSiteVisiting(this.costCenterName,
				this.costCenterArea,
				this.address,
	...
	public String PrintPDF()
	{
		...
		try {
			...
			par.add(chunk);
			chunk = new Chunk(" on the above matter. An officer will be visiting to the said premises on ",TIMES_ROMAN);
			par.add(chunk);
			chunk = new Chunk(this.visitedDate,TIMES_BOLD);
			par.add(chunk);
			...
			par = new   Paragraph("My officers will require to inspect the said premises , therefore you/responsible persons are kindly requested  availlable at the said premises.",TIMES_ROMAN);
			par.setAlignment(Element.ALIGN_JUSTIFIED);
			document.add(par);
			document.add(new Paragraph("\n"));
