...
public class PDFConsumerEnergize implements Printable {
	...
	public PDFConsumerEnergize(String costCenterName,String costCenterArea,
			String address,String applicationNumber,String customerName,
			String street,String  suberb,String city,String postalCode,String phase,String appDate,Date visitedDate,String session )
	{
	...
	public void Printx()
	{
		...
		Book book = new Book();	
		book.append(new PDFConsumerEnergize(this.costCenterName,
				this.costCenterArea,
				this.address,
	...
	public String PrintPDF()
	{
		...
		try {
			...
			par.add(chunk);
			chunk = new Chunk(" session to enagize. ",TIMES_ROMAN);
			par.add(chunk);
			...
			par = new   Paragraph("My officers will require to inspect the said premises , therefore you are kindly requested to visit this office together with required information and to obtain advices in this regard please.",TIMES_ROMAN);
			par.setAlignment(Element.ALIGN_LEFT);
			document.add(par);
			document.add(new Paragraph("\n"));
