...
public class ApplicationCR extends ActionSupport implements SessionAware,
		ParameterAware {
	// Common Fields
	...
	private static final String newPath="Cost Recovery>Application>New Application";
	private static final String viewPath="Cost Recovery>Application>View Application";
	private static final String modifyPath="Cost Recovery>Application>Modify Application";
	private static final String confirmPath="Cost Recovery>Application>Generate App No";	
	//
...
private WiringLandDetail updateWiringLandDetailModel(WiringLandDetail wiringLandDetail) throws NumberFormatException{
	...
	private void setWiringLandDetail(WiringLandDetail wiringLandDetail) throws NumberFormatException{
		...
		*/
		...
		System.out.println("%%%%%%%%%%%%%%%%%%%%%%getPhase()  "+wiringLandDetail.getPhase());
		if (wiringLandDetail.getPhase() != null)
