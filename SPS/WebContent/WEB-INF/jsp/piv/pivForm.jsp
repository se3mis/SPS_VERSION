				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="0" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="pivForm" method="POST"
										...
										<table width="100%" class="tldFromContent" border="0" >
											...
											<tbody>
																...
																<table  width="100%" class="tldFromContent" border="0">
																	...
																	<tbody>
																		...
																		<tr>
																			...
																			<td><s:select name="chequeBankCode" id="txfdChequeBankCode" headerKey=""  headerValue="Select Bank" list="bankList"  listKey="bankCode" listValue="%{bankCode+' - '+bankName}" onchange="javascript:display_branches()" /></td>
																		</tr>
																		<tr>
																			<td><s:label value="Branch Code"></s:label></td>
																			<td><s:textfield name="chequeBranchCode" id="txfdChequeBranchCode" size="10" ></s:textfield></td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			...
																			<td><s:textfield name="chequeNo" id="txfdChequeNo" size="20" ></s:textfield></td>
																		</tr>
																		<tr>
																			...
																			<table width="100%" class="tldFromContent" border="0" >
																				...
																				<tbody>
																					...
																					<tr>
																						...
																						<td align="right"><s:textfield name="miscellaneousIncome" id="txfdMiscellaneousIncome" size="10" onkeypress="return restrictToTwoDecimalPossition(this,event)" onchange="return setSubTotal()"></s:textfield></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td><s:label value="3600"></s:label></td>
																						<td><s:label value="Electricity Debtors"></s:label></td>
																						<td align="right"><s:textfield  name="electricityDebtors" id="txfdElectricityDebtors"   size="10" onchange="return setSubTotal()"></s:textfield></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td><s:label value="5600"></s:label></td>
																						<td><s:label value="Security Deposit"></s:label></td>
																						<td align="right"><s:textfield name="securityDeposit" id="txfdSecurityDeposit"  size="10" onchange="return setSubTotal()"></s:textfield></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td><s:label value="5610"></s:label></td>
																						<td><s:label value="Service Connection/Electricity Schemes"></s:label></td>
																						<td align="right"><s:textfield name="serConnOrElecSch" id="txfdSerConnOrElecSch"  size="10" onchange="return setSubTotal()"></s:textfield></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td><s:label value="5640"></s:label></td>
																						<td><s:label value="Tender Deposit"></s:label></td>
																						<td align="right"><s:textfield name="tenderDeposit" id="txfdTenderDeposit"  size="10" onchange="return setSubTotal()"></s:textfield></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td><s:label value="5660"></s:label></td>
																						<td><s:label value="Miscellaneous Deposit"></s:label></td>
																						<td align="right"><s:textfield name="miscellaneousDeposit" id="txfdMiscellaneousDeposit"  size="10" onchange="return setSubTotal()"></s:textfield></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td><s:label value="5800"></s:label></td>
																						<td><s:label value="Cash in Transit"></s:label></td>
																						<td align="right"><s:textfield name="cashInTransit" id="txfdCashInTransit"  size="10" onchange="return setSubTotal()"></s:textfield></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td><s:label value="5910"></s:label></td>
																						<td><s:label value="For Dishonoured Cheque"></s:label></td>
																						<td align="right"><s:textfield name="forDishonouredCheque" id="txfdForDishonouredCheque"  size="10" onchange="return setSubTotal()"></s:textfield></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td><s:label value="1380"></s:label></td>
																						<td><s:label value="Application Fee"></s:label></td>
																						<td align="right"><s:textfield name="applicationFee" id="txfdApplicationFee" size="10" readonly="true" onkeypress="return restrictToTwoDecimalPossition(this,event)" onchange="return setSubTotal()"></s:textfield></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td height="10"></td>
																					...
																					<tr>
																						...
																						<td align="right"><s:textfield name="subTotal" id="txfdSubTotal" readonly="true" size="10" ></s:textfield></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td><s:label value="5222"></s:label></td>
																						<td><s:label value="V.A.T."></s:label></td>
																						<td align="right"><s:textfield name="vat" id="txfdVat"  size="10" onchange="return  setGrandTotal()()"></s:textfield></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td height="10"></td>
																					...
																					<tr>
																						...
																						<td align="right"><s:textfield name="grandTotal" id="txfdGrandTotal" readonly="true" size="10" ></s:textfield></td>
																						<td></td>
																					</tr>
																			</tbody>
																			</table>
												...
												<tr>
													...
													<s:submit theme="simple" value="Save & Print" method="save" id="btnSave" onclick="return validate_form()"></s:submit>
													<!--  <input type="button"  value="Print"  id="btnPrint" onclick="callPrintEstimate()"></input>-->
													<s:if test="%{state=='afterestimatedDone'}"> 
													<s:submit theme="simple" value="Save & Print" method="saveAfter" id="btnSave" onclick="return validate_form()"></s:submit>
													</s:if>
