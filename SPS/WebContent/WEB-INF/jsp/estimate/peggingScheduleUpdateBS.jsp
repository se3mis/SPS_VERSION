		...
		function(json){ 
				...
				$.each(json.otherMaterials,function(i,otherMaterialsjson){
					...
					var otherMattable = '<tr  id="otherMaterials'+otherMaterialsjson.resourceCode+'">'+
								'<td align="right"><input type="checkbox" class="required" style="text-align: left" name="chkMatCode" id="'+otherMaterialsjson.resourceCode+'"  value="" onclick("checkAlreadySelected()")  /></td>'+	
		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						<s:form id="frmEstimate" name="frmEstimate" action="pegSchedule!updateDetailEstimation" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<tr>
									 <s:url id="page_url" namespace="/progressMonitoring/web" action="addProgress">
                                                                  <s:param name="estimateNo" value="%{estimateNo}" />
									...
									<td  ><s:a href="%{page_url}">Modify Progress Initial Data<s:property value="estimateNo" /></s:a></td>
									...
									<s:submit theme="simple" value="Print Estimate" method="PrintEstimate" id="btnprint" ></s:submit>
									<s:submit theme="simple" value="Print(A4) Estimate" method="PrintEstimateA4" id="btnprint1" ></s:submit>
