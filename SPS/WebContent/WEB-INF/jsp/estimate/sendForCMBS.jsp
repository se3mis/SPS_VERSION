				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form name="estimateViewer" action="sendForConsMain" method="POST" 
...
<br></td>												<td width="20%"> <s:property  value="id.applicationNo" /></td>	
												...
												<tr>                             
													...
													Post Dept ID : <s:select name="postId" id="postId" list="postIdList"></s:select>
														...
														<!-- /s:if-->
													<s:submit otheme="simple" align="right" value="Send CONS & DM" method="sendForCM" id="sendForCM" onclick="return confirm('Are You sure?')" ></s:submit>
