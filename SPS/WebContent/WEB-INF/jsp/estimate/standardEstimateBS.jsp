				...
				//alert(json.disable);
					...
					$.each(json.addednorms,function(i,normjson){
						...
						var pkgTable1 = '<tr  id="linesecid'+normjson.linesectionid+'">'+		
									...
									//'<td id="totalcost'+normjson.linesectionid+'" align="right" style="color: #003300;">'+normjson.estimatecost+'</td>'+
			...
			function(json){
					...
					$.each(json.addednorms,function(i,normjson){
						...
						var pkgTable1 = '<tr  id="linesecid'+normjson.linesectionid+'">'+		
									...
									'<td id="uom'+normjson.linesectionid+'" align="left" >'+normjson.uom+'</td>'+
									'<td id="description'+normjson.linesectionid+'" align="left" >'+normjson.description+'</td>'+
									'<td align="right"><input type="text" class="required" style="text-align: right" name="quantity'+i+'" id="quantity'+normjson.linesectionid+'"  maxlength="10" size="10"  style="text-align: right;color: green;" value="0"  onchange="onQuantityChange(this,'+normjson.standardcost+',\'' + normjson.linesectionid + '\')"  /></td>'+
									'<td id="standardcost'+normjson.linesectionid+'" align="right" style="color: #003300;">'+normjson.standardcost+'</td>'+
						...
						<s:form id="frmEstimate" name="frmEstimate" action="estimateBS!saveEstimation" method="POST"
						  		...
						  		<table width="100%" border="0" class="tldFromContent1">
														...
														<tr height="20">
															...
															<td><input type="text" name="powerTosupply" id="powerTosupply" size="50" /></td>
															<td>&nbsp;</td>
														...
														<tr height="20">
															<td>&nbsp;</td>
																...
																<td colspan="5"><input type="button" id="landAddSub" value="Land-Add Sub" onclick="addLandBulkSubCost();"/><input type="button"  id="bulkAddSub" value="Bulk-Add Sub"  onclick="addLandBulkSubCost();"/></td>
														...
														<tr height="20">
															<td>&nbsp;</td>
																...
																<s:submit theme="simple" value="Investigation Report" method="generateInvestigationReport" id="btnPrint" ></s:submit>
						...
						<table class="tldFromContent1" width="100%">							
							<tr>
					  		...
					  		<table id="pkgtable1" align="center" border="0">
					  			<tr id="header2"><th></th> 
									<th><b>Line Id<b></th><th><b>UOM<b></th> <th><b>Description<b></th><th><b>Standard Cost<b></th></tr>
					 			<tr id="linesecid"><td></td><td id="uom"></td><td id="description"></td><td id="quantity"></td><td id="standardcost"></td>
					  				<td id="totalcost"></td></tr>
