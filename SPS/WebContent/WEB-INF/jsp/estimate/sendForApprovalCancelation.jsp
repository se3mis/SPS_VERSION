				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form name="estimateViewer" action="approveCancellation" method="POST" 
...
<td width="2%"><input type="radio" onClick="document.getElementById('hiddenEstimateNo').value = '<s:property value="id.applicationNo" />';" name='applicationId' value='<s:property value="id.applicationNo" />' />
<br></td>												<td width="20%"> <s:property  value="id.applicationNo" /></td>	
														<td width="20%"> <s:text name="format.currency"><s:param value="totalCost"/></s:text></td>														 
												...
												<tr>                             
													...
													<s:submit theme="simple" align="right" value="  UnPost  " method="approveCancellationCommercial" id="approveCancellation" ></s:submit>
