		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr>
						<td>
						<s:form id="frmEstimate" name="frmEstimate" action="estimateBS!Cancel" method="POST" validate="true" theme="simple">
						  		<table width="100%" border="0" class="tldFromContent1">
														...
														<tr height="20">
															<td>&nbsp;</td>
																...
																<td colspan="5"><s:submit theme="simple" value="Estimate Cancel" method="jobcancel" id="cancel" disabled="false" onclick ="return confirm('Are you sure you want to Cancel this?')"></s:submit>
																...
																<!--<s:submit theme="simple" value="View Dispatch of PIV" method="PrintDispatchOFPIV" id="btnprint3" ></s:submit>
																
											
																<s:submit theme="simple" value="View Dispatch of PIV NEW" method="PrintDispatchOFPIVNew" id="btnprint4" ></s:submit>-->
