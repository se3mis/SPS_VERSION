	...
	//alert(escape(resourType))
		...
		function(json){ 
				...
				$.each(json.addedMaterials,function(i,estimateDetails){
					...
					'<td id="uom'+estimateDetails.selectedPegId+'" align="middle" >'+estimateDetails.uom+'</td>';
					//'<td id="unitPrice'+estimateDetails.selectedPegId+'" align="middle" >'+estimateDetails.unitPrice+'</td>';
					
					var estimateDetailsOtherResource ='<td id="unitPrice'+estimateDetails.selectedPegId+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetails.unitPrice+'" id="'+estimateDetails.unitPrice+'"  maxlength="20" size="20" value="" onchange="onNumChange(this,'+estimateDetails.unitPrice+',\'' + estimateDetails.selectedPegId + '\')"/></td>'+
			...
			$.getJSON("smc/showPegInfo.ajax?selectedPegId="+selectedID+"&selectedPegText="+selectedIDValue+"&quantity="+document.getElementById('itemquantity').value+"&applicationId="+applicationId, {
				...
				function(json){ 
					...
					var estimateDetails = '<tr  id="lineseciid'+estimateDetail.resourceCode+'">'+	
									...
									'<td id="estimateQuantity'+estimateDetail.resourceCode+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetail.estimateQuantity+'" id="'+estimateDetail.estimateQuantity+'"  maxlength="20" size="20"  value="'+estimateDetail.estimateQuantity+'" onchange="calculateTotal(this,'+estimateDetail.unitPrice+',\'' + estimateDetail.resourceCode + '\')"  /></td>'+
									'<td align="middle" ><input type="text" class="required" style="text-align: right;color: green;"  name="estimateCost"  id="estimateCost'+estimateDetail.resourceCode+'"  maxlength="20" size="20" value="'+estimateDetail.estimateCost+'"  /></td>'+
...
//alert(json.estimateDetails.length);			
			...
			$.each(json.estimateDetails,function(i,estimateDetail){
					...
					var estimateDetails = '<tr  id="lineseciid'+estimateDetail.resourceCode+'">'+	
									...
									'<td id="uom'+estimateDetail.resourceCode+'" align="left" >'+estimateDetail.uom+'</td>'+
									'<td id="unitPrice'+estimateDetail.resourceCode+'" align="left" >'+estimateDetail.unitPrice+'</td>'+
									'<td id="estimateQuantity'+estimateDetail.resourceCode+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetail.estimateQuantity+'" id="'+estimateDetail.estimateQuantity+'"  maxlength="20" readonly="true" size="20"  value="'+estimateDetail.estimateQuantity+'" onchange="onNumChange(this,'+estimateDetail.unitPrice+',\'' + estimateDetail.resourceCode + '\')"  /></td>'+
		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						<s:form id="frmEstimate" name="frmEstimate" action="itemByItem!workEstiValidate" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<td  width="25%">
									<s:if test="%{loggedInUserLevel=='CE' || loggedInUserLevel=='DGM'}"> 
											<s:submit theme="simple" value="Approve" method="approve" id="Validate" ></s:submit>
									</s:if>	
									<s:elseif test="%{loggedInUserLevel=='EE' || loggedInUserLevel=='CE' || loggedInUserLevel=='PE' || loggedInUserLevel=='ES'}">
											<s:submit theme="simple" value="Validate" method="approve" id="Validate" ></s:submit>
									</s:elseif>
									<!--<s:submit theme="simple" value="Validate" method="approve" id="Validate" ></s:submit>-->
									<s:submit theme="simple" value="Reject" method="reject" id="Reject" ></s:submit>
