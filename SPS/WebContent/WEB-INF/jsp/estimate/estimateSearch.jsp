...
var requestcostCenterNo = $("#costCenterNo").val();
var fileRef = $("#fileRef").val();
		...
		$.getJSON("smc/loadEstimationDetails.ajax?estimateNo="+estimateNo+"&requestCostCenter"+requestcostCenterNo+"&fileRef"+fileRef, {
		ajax_command: "searchEstimate",ajax_ieCacheFix:new Date().getTime() },
		function(json){ 
			if(json.invalid){
			   // invalidStatus = "true";
			...
			<table id="tblInner" class="tblInner" >
					...
					<tr  class="tblInner">
						...
						<s:form id="frmEstimate" name="frmEstimate" action="pegSchedule!updateDetailEstimationItembyitemView" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<input type="text" name="estimateNo"  id="estimateNo"  size="30"/><input type="button"  value="Search" onclick="loadEstimationData();"/>
									</td>
									...
									<td width="30%"><input type="text" name="projectNo"  id="projectNo"  size="30" disabled="disabled"/ >
				...
				<tr>
						...
						<table>
							...
							<tr>
							<td>
							<table  class="tldFromContent1" id="approvalTable" align="left"  style="display:block;" border="1">
					  			<tr id="header1">
