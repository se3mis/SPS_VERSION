				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="0" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form id="frmEstimate" name="frmEstimate" action="estimate" method="POST"
													...
													<td valign="top">
														<table border="0">
															...
															<tr>
																...
																<td>
																	<s:url id="estcost_url" value="estimate!calEstCostToLineLen" />
																	...
																	<table width="100%">
																		<tr>
																			<td>
																				...
																				<s:url id="add_polemat_url" value="MaterialAction!addPoleMaterials" />
																		...
																		<tr>
																			<td align="center">
																				<s:url id="polematparam_url" value="MaterialAction!displayPoleMaterialParams" />
