			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						...
						<td>
						<s:form id="frmEstimate" name="frmEstimate" action="pegSchedule!workEstiCancel" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<s:if test="%{loggedInUserLevel=='ES' || loggedInUserLevel=='EE' || loggedInUserLevel=='DGM' || loggedInUserLevel=='CE' || loggedInUserLevel=='PE' || loggedInUserLevel=='PCE'}"> 
									...
									<s:submit theme="simple" value="Cancel Estimate" method="cancel" id="Cancel" onclick="return confirm('Are You Sure ?')"></s:submit>
