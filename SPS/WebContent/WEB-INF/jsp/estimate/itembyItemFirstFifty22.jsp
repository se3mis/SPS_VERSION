...
function generateWorkEstNo(){
	...
	$.getJSON("smc/generateWorkEstNo.ajax?applicationId="+applicationId, {
			ajax_command: "generateEstimateNoForFirstFifty",ajax_ieCacheFix:new Date().getTime() },
			function(json){ 
	...
	//alert(escape(resourType))
		...
		function(json){ 
				...
				$.each(json.addedMaterials,function(i,estimateDetails){
					...
					var estimateDetailsOtherResource ='<td id="unitPrice'+estimateDetails.selectedPegId+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="unitPrice'+estimateDetails.selectedPegId+'" id="unitPrice'+estimateDetails.selectedPegId+'"  maxlength="20" size="20" value="'+estimateDetails.unitPrice+'" onchange="onNumChange(this,'+estimateDetails.unitPrice+',\'' + estimateDetails.selectedPegId + '\')"/></td>'+
					'<td id="estimateQuantity'+estimateDetails.selectedPegId+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="estimateQuantity'+estimateDetails.selectedPegId+'" id="estimateQuantity'+estimateDetails.selectedPegId+'"  maxlength="20" size="20" value="1"  onchange="onNumChange(this,'+estimateDetails.unitPrice+',\'' + estimateDetails.selectedPegId + '\')" /></td>'+
					...
					var estimateDetailsNPL ='<td id="unitPrice'+estimateDetails.selectedPegId+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetails.unitPrice+'" id="unitPrice1'+estimateDetails.selectedPegId+'"  maxlength="20" size="20" value="'+estimateDetails.unitPrice+'" onchange="onQuantityChange(this,'+estimateDetails.unitPrice+',\'' + estimateDetails.selectedPegId + '\')"/></td>'+
						'<td id="estimateQuantity'+estimateDetails.selectedPegId+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetails.estimateQuantity+'" id="estimateQuantity1'+estimateDetails.selectedPegId+'"   maxlength="20" size="20" value="1"  onchange="onQuantityChange(this,'+estimateDetails.unitPrice+',\'' + estimateDetails.selectedPegId + '\')" /></td>'+
							'<td align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="estimateCost"  id="estimateCost'+estimateDetails.selectedPegId+'"  maxlength="10" size="10" value="" readOnly="true" onchange="onNumChange(this,'+estimateDetails.unitPrice+',\'' + estimateDetails.selectedPegId + '\')" /></td>'+
							'<td width=\'25px\' align=\'center\'><image onclick="deleteDetailLine(\'' + estimateDetails.isFromPegSchedule + '\'' +',\'' + estimateDetails.selectedPegId + '\'' +',\'' + resourType+'\')" src="../../image/X.png" /></td>'+
						
							'</tr>';
					
					var estimateDetailsOther ='<td id="unitPrice'+estimateDetails.selectedPegId+'" align="left" >'+estimateDetails.unitPrice+'</td>'+
					'<td id="estimateQuantity'+estimateDetails.selectedPegId+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="estimateQuantity'+estimateDetails.selectedPegId+'" id="estimateQuantity'+estimateDetails.selectedPegId+'"  maxlength="20" size="20" value="" onchange="onNumChange(this,'+estimateDetails.unitPrice+',\'' + estimateDetails.selectedPegId + '\')" /></td>'+
			...
			$.getJSON("smc/showPegInfo.ajax?selectedPegId="+selectedID+"&selectedPegText="+selectedIDValue+"&quantity="+document.getElementById('itemquantity').value+"&applicationId="+applicationId, {
				...
				function(json){ 
					...
					var estimateDetails = '<tr  id="lineseciid'+estimateDetail.resourceCode+'">'+	
									...
									'<td id="estimateQuantity'+estimateDetail.resourceCode+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetail.estimateQuantity+'" id="'+estimateDetail.estimateQuantity+'"  maxlength="10" size="10"  value="'+estimateDetail.estimateQuantity+'" onchange="calculateTotal(this,'+estimateDetail.unitPrice+',\'' + estimateDetail.resourceCode + '\')"  /></td>'+
									'<td align="middle" ><input type="text" class="required" style="text-align: right;color: green;"  name="estimateCost"  id="estimateCost'+estimateDetail.resourceCode+'"  maxlength="10" size="10" value="'+estimateDetail.estimateCost+'"  /></td>'+
		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						<s:form id="frmEstimate" name="frmEstimate" action="pegSchedule!updateDetailEstimationItembyitem" method="POST"
										validate="true" theme="simple">
						  		<table align="center" class="tldFromContent1" width="100%">
						  			<tr>
									<td width="25%">Esimate No</td>
									<td width="30%"><input type="text" name="estimateNo"  id="estimateNo" /><input type="button" name="generateNo" id="generateNo" value="generateNo" onclick="generateWorkEstNo();"/></td>
									...
									<td  width="25%"><input type="submit" name="totalCost2" value="Update"  id="Update" onclick="return validateForm()"/>
									...
									<!--<s:if test="%{costCenterNo=='550.20' || costCenterNo=='550.30' || costCenterNo=='510.20' || costCenterNo=='510.30' || costCenterNo=='520.20' || costCenterNo=='520.30'}">
										...
										<applet codebase="../../PrintEstimateLib" code="sps.estimate.PrintApplet" name="pivApplet" archive="PrintEstimate.jar" width="1" height="1"></applet>
