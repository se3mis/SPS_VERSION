...
function loadDropDownDetails(){

	var estimateNo=$("#estimateNo").val();	
	if(estimateNo!="" || estimateNo.length !=0){
		loadDefaultDropDownsValues();
	}else{
		alert("Please Enter Estimate No");
	}
				...
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						  		...
						  		<s:form id="frmEstimate1" name="frmEstimate1" action="pegSchedule!saveDetailEstimationItembyitemWCoRef" method="POST" validate="true" theme="simple">
						  		<table align="center" class="tldFromContent1" width="100%">
						  			<tr>
									<td width="25%">Esimate No</td>
									<td width="30%"><input type="text" name="estimateNo"  id="estimateNo" size="20" maxlength="20"/>
									<input type="button" name="checkAvailable" id="checkAvailable" value="checkAvailable" onclick="checkAvailability();"/>
									<input type="button" name="generateNo" id="generateNo" value="generateNo" onclick="generateWorkEstNo();" />
									<!--  <input type="button" name="checkNumber" id="checkNumber" value="Load Details" onclick="loadDropDownDetails();"/>--></td>
									...
									<td  width="25%">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td  width="25%">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td  width="25%"><input type="submit" name="totalCost2" value="Save"  id="save" onclick="return validateForm()"/><s:submit theme="simple" value="Exit" method="close" id="btnClose" ></s:submit><input type="button"  value="Clear" onclick="clearFormDetails();"/></td>
									</tr>
									<tr>
