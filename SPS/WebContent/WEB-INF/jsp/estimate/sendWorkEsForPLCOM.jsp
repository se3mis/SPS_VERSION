				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form name="estimateViewer" action="pegSchedule!sendForWEPLCOM" method="POST" 
											...
											<tbody>
												...
												<tr>
													...
													<table width="80%" class="tldFromContent" border="0" >
														<thead>
															<tr>
																...
																<th width="20%" align="left">Estimate No</th>
													...
													<s:iterator status="estimate" value="EstimateList">
                                                        ...
                                                        <td><s:checkbox	name="DetailsList" fieldValue="%{id.estimateNo}" /></td>
												        <td width="20%"> <s:property  value="id.estimateNo" /></td>	
												...
												<tr>                             
													...
													<!--<s:submit theme="simple" align="right" value="Post ES" method="postES" id="post" ></s:submit>-->
													<!-- Send to : <s:select name="postUserName" id="postUserName" list="listuserName"></s:select>-->
													<s:submit theme="simple" align="right" value="Send For Planning CE" method="postPL" id="post" ></s:submit>
													<s:submit theme="simple" align="right" value="Send For Commecial CE" method="postCOM" id="post" ></s:submit>
