				...
				$.each(json.addedMaterials,function(i,estimateDetails){
					...
					var estimateDetailsNPL ='<td id="unitPrice'+estimateDetails.selectedPegId+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetails.unitPrice+'" id="unitPrice1'+estimateDetails.selectedPegId+'"  maxlength="20" size="20" value="'+estimateDetails.unitPrice+'" onchange="onQuantityChange1(this,'+estimateDetails.unitPrice+',\'' + estimateDetails.selectedPegId + '\')"/></td>'+
						'<td id="estimateQuantity'+estimateDetails.selectedPegId+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetails.estimateQuantity+'" id="estimateQuantity1'+estimateDetails.selectedPegId+'"   maxlength="20" size="20" value="1"  onchange="onQuantityChange(this,'+estimateDetails.unitPrice+',\'' + estimateDetails.selectedPegId + '\')" /></td>'+
							'<td align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="estimateCost"  id="estimateCost'+estimateDetails.selectedPegId+'"  maxlength="20" size="20" value="" onchange="onNumChange(this,'+estimateDetails.unitPrice+',\'' + estimateDetails.selectedPegId + '\')" /></td>'+
							'<td width=\'25px\' align=\'center\'><image onclick="deleteDetailLine(\'' + estimateDetails.isFromPegSchedule + '\'' +',\'' + estimateDetails.selectedPegId + '\'' +',\'' + resourType+'\')" src="../../image/X.png" /></td>'+
		       ...
		       return;
				...
				$.getJSON("smc/getEstimatedUpdateDetails.ajax?lineid="+resourceCode+"&quantity="+quan.value+"&linecost="+estmatedCost+"&unitcost="+standCost, {
					...
					function(json){ 
						...
						'<td id="quantity'+json.selectedPegId+'" align="left" ><input type="text" class="required" style="text-align: right" name="quantity" id="'+json.selectedPegId+'"  value="'+json.quantity+'"  readOnly="true" /></td>'+
...
function loadEstimateData(){
	...
	//alert(resourceType.value);
		...
		function(json){ 
			...
			$('#totalCost').val(json.totalCost);
			$("#totalCostDisplay").val(intToFormat(totalCost));
			if (json.jsonarrayResourceCodes != null && json.jsonarrayResourceCodes.length > 0) {
				for (x = 0; x < json.jsonarrayResourceCodes.length; x++) {
			...
			if($('#isApprovable').val()=="true"){
				...
				$.each(json.estimateDetails,function(i,estimateDetail){
						...
						var estimateDetails = '<tr  id="lineseciid'+estimateDetail.resourceCode+'">'+	
										...
										'<td align="left" ><input type="text" class="required" style="text-align: right;color: green;"  name="estimateCost"  id="estimateCost'+estimateDetail.resourceCode+'"  maxlength="20" readonly="true" size="20" value="'+estimateDetail.estimateCost+'"  /></td>'+
										'<td id="rebateQuantity'+estimateDetail.rebateQuantity+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetail.rebateQuantity+'" id="'+estimateDetail.rebateQuantity+'"  maxlength="20"  size="20"  value="'+estimateDetail.rebateQuantity+'"  readonly="true" /></td>'+
										'<td align="left" ><input type="text" class="required" style="text-align: right;color: green;"  name="rebateCost"  id="rebateCost'+estimateDetail.resourceCode+'"  maxlength="20" readonly="true" size="20" value="'+estimateDetail.rebateCost+'"  /></td>'+
										'<td id="reusableQuantity'+estimateDetail.reusableQuantity+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetail.reusableQuantity+'" id="'+estimateDetail.reusableQuantity+'"  maxlength="20"  size="20"  value="'+estimateDetail.reusableQuantity+'"  readonly="true" /></td>'+
										'<td id="offChargeQuantity'+estimateDetail.offChargeQuantity+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetail.offChargeQuantity+'" id="'+estimateDetail.offChargeQuantity+'"  maxlength="20"  size="20"  value="'+estimateDetail.offChargeQuantity+'"  readonly="true" /></td>'+
				...
				$.each(json.pegDetails,function(i,pegDetail){
					...
					'<td id="quantity1'+pegDetail.selectedPegId+'" align="left" ><input type="text" class="required" style="text-align: right" name="quantity" id="quantity'+pegDetail.selectedPegId+'"  readOnly="true" value="'+pegDetail.quantity+'" onchange="onPegItemChange(this,'+'\''+pegDetail.selectedPegId + '\')"/></td>'+
					//'<td align="right"><input type="text" class="required" style="text-align: right" name="'+json.quantity+'" id="'+json.quantity+'"  maxlength="10" size="10" value="" onchange="onNumChange1(this)" /></td>'+
					//'<td width=\'25px\' align=\'center\'><image onclick="deletePegDetailLine(\'' + json.selectedPegId + '\')" src="../../image/X.png" /></td>'+
					'</tr>';
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						...
						<td>
						<s:form id="frmEstimate" name="frmEstimate" action="pegSchedule!workEstiValidate" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
						  			<tr>                             
										...
										<s:submit cssClass="buttonExit" theme="simple"
											align="right" value="X" method="close" id="btnClose"></s:submit></td>
									...
									<tr>
									<td  width="30%">Scheme Name/Extension:</td>
									<td  width="70%"><input type="text" name="schemeDetails"  id="schemeDetails" readOnly="true" size="60" /></td>
									<td  width="25%">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td  width="25%">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td  width="25%">Approval Comment</td>
									<td  width="25%"><textarea name="approvalComment" id="approvalComment" rows="2" cols="60" ></textarea></td>
									
									</tr>
									
									<tr>
									<s:if test="%{loggedInUserLevel=='EE' || loggedInUserLevel=='CE'}"> 
									<td  width="25%">Standard Estimate Cost :<input type="text" name="stdtotalCost"  id="stdtotalCost" readOnly="true"/> </td>
									<td  width="25%">Rebate Cost :<input type="text" name="rebateCost"  id="rebateCost" readOnly="true"/></td>
									...
									<td  width="25%">
									<s:if test="%{(loggedInUserLevel == 'ES' || loggedInUserLevel == 'EE' || loggedInUserLevel == 'CE')}">
										
										<s:submit theme="simple" value="Update" method="updateAndValidate" id="update" ></s:submit>
									</s:if>
									
									
									<s:if test="%{loggedInUserLevel=='ES' || loggedInUserLevel=='EE' || loggedInUserLevel=='DGM' || loggedInUserLevel=='AGM' ||loggedInUserLevel=='CE' || loggedInUserLevel=='PE' || loggedInUserLevel=='PCE'}"> 
									...
									<!--<s:submit theme="simple" value="Validate" method="approve" id="Validate" ></s:submit>-->
