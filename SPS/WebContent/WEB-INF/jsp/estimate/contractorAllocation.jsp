...
function loadContractors(){
	$("#ContractorList select option:gt(0)").remove();
	 $.getJSON("sps/loadContractors.ajax", {ajax_command:"loadContractors",ajax_ieCacheFix:new Date().getTime()}, function(json) {
...
function validateForm()
{
	 ...
	 var appointedUserName=$("#appointedUserName").val();
	 
	 if(appointedUserName==-1)
	 {
		 alert('Please enter supervised User!!');
		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						<s:form id="frmEstimate" name="frmEstimate" action="saveJobAllocationBS" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<td  width="25%">Contractor</td>
									<td  width="25%"><div id="ContractorList">
									...
									<input type="submit" name="totalCost2" value="allocateContractor"  id="allocateContractor" onclick="return validateForm()"/>	
									
									<s:submit theme="simple" value="Exit" method="close" id="btnClose" ></s:submit>
									<input type="button"  value="Clear" onclick="clearFormDetails();"/></td>
									</tr>
