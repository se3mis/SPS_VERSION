		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
							<s:form id="frmEstimate" name="frmEstimate" action="pegSchedule!deleteDetailEstimationItembyitem" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<td  width="25%">	<s:submit theme="simple" value="Delete Estimate" method="deleteDetailEstimation" id="btnprint" ></s:submit>
