		       ...
		       return;
				...
				$.getJSON("smc/getEstimatedUpdateDetails.ajax?lineid="+resourceCode+"&quantity="+quan.value+"&linecost="+estmatedCost+"&unitcost="+unitPrice, {
					...
					function(json){ 
						...
						//$("#estimateQuantity"+resourceCode).val(json.estimateQuantity);
						//$("#estimateCost"+resourceCode).val(json.estimateCost);
		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						<s:form id="frmEstimate" name="frmEstimate" action="pegSchedule!saveDetailEstimationWComRef" method="POST"
