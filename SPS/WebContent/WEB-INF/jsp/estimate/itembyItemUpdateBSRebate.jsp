		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						<s:form id="frmEstimate" name="frmEstimate" action="pegSchedule!updateDetailEstimationItembyitemRebate"  enctype="multipart/form-data" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<s:submit theme="simple" value="Exit" method="close" id="btnClose" /></td>
									<td>
