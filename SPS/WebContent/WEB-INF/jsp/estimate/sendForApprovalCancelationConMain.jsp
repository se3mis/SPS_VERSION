				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form name="estimateViewer" action="approveCancellationConMain" method="POST" 
										...
										<table width="100%" class="tldFromContent" border="0">
											...
											<tbody>
												...
												<tr>
													...
													<s:iterator status="estimate" value="EstimateListConMain">
														<tr bgcolor="#9DCBE6">
														<s:hidden name="hiddenEstimateNo" id="hiddenEstimateNo" /> 
<td width="2%"><input type="radio" onClick="document.getElementById('hiddenEstimateNo').value = '<s:property value="id.estimateNo" />';" name='applicationId' value='<s:property value="id.estimateNo" />' />
<br></td>												<td width="20%"> <s:property  value="id.estimateNo" /></td>	
												...
												<tr>                             
													...
													<s:submit theme="simple" align="right" value="  UnPost  " method="approveCancellationConMain" id="approveCancellation" ></s:submit>
