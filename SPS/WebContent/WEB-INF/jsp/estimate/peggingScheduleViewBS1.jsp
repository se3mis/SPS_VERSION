					...
					<tr  class="tblInner">
						...
						<s:form id="frmEstimate" name="frmEstimate" action="pegSchedule!updateDetailEstimationItembyitemView" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<td  width="25%"><input type="text"  name="it1" id="pivDatePicker" readOnly="true" disabled="disabled"/></td>
									<td  width="25%">&nbsp;</td>
									<td  width="25%">&nbsp;</td>
									</tr>
									...
									<td  width="25%">
									<s:submit theme="simple" value="Print(A3)" method="PrintEstimateA3" id="btnprint2" ></s:submit>
										
									<s:submit theme="simple" value="Print(A4)" method="PrintEstimateA4" id="btnprint" ></s:submit>
