		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr>
						<td>
						<s:form id="frmEstimate" name="frmEstimate" action="estimateBS!standardEstiValidate" method="POST"
						  		...
						  		<table width="100%" border="0" class="tldFromContent1">
														...
														<tr height="20">
															...
															<td  width="25%"><input type="text" name="status"  id="status" readOnly="true" size="50" style="background-color:#AFEEEE;"/></td>
																...
																<td><input type="text" name="postId" id="postId" disabled="disabled"/></td>
														...
														<tr height="20">
															<td>&nbsp;</td>
																...
																<td colspan="5"><s:submit theme="simple" value="Validate" method="approve" id="Validate" disabled="true"></s:submit>
																...
																<s:submit theme="simple" value="Print Award Letter New With Header" method="PrintAwardNewWithHeader" id="btnprint2" ></s:submit>
																<s:submit theme="simple" value="Print Award Letter New WithOut Header" method="PrintAwardNewWithOutHeader" id="btnprint2" ></s:submit>
