...
function addPegItems(){
	...
	//alert(document.getElementById('itemquantity').value);
			...
			$.getJSON("smc/showPegInfo.ajax?selectedPegId="+selectedID+"&selectedPegText="+selectedIDValue+"&quantity="+document.getElementById('itemquantity').value+"&applicationId="+applicationId+"&estimateNo="+estimateNo, {
...
function loadStdEstimationRefs(){
	clearPeggingScheduleForm();
	 $.getJSON("sps/loadFFJobNumbers.ajax?selectedCustomer=" + 1, {ajax_command:"loadFFJobNumbers",ajax_ieCacheFix:new Date().getTime()}, function(json) {
...
clearPeggingScheduleForm();
	 ...
	 $.getJSON("sps/loadDefaultDropDownsValues.ajax?selectedCustomer=" + 1, {ajax_command:"loadDefaultDropDownsValues",ajax_ieCacheFix:new Date().getTime()}, function(json) {
		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						<s:form id="frmEstimate1" name="frmEstimate1" action="pegSchedule!saveDetailEstimationItembyitem" method="POST"
										validate="true" theme="simple">
						  		<table align="center" class="tldFromContent1" width="100%">
						  			<tr>
									<td width="25%">Esimate No</td>
									<td width="30%"><input type="text" name="estimateNo"  id="estimateNo" /></td>
									...
									<td  width="25%">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td  width="25%">&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td  width="25%"><input type="submit" name="totalCost2" value="Save"  id="save" onclick="return validateForm()"/><input type="submit" name="print" id="print" value="Print"/><s:submit theme="simple" value="Exit" method="close" id="btnClose" ></s:submit><input type="button"  value="Clear" onclick="clearFormDetails();"/></td>
									</tr>
									<tr>
						...
						<tr>
							...
							<tr>
								...
								<div id="otherResourcesdiv" style="display:none">
									...
									<!--  <div id="newEstimaleDetails" style="display:none;">
										Job Information
										<table align="center" class="tldFromContent1" width="100%">
											<tr>
											<td width="25%">Res Type</td>
											<td width="25%">
											<div id="resourceTypes"><select name="resourceTypeId" id="resourceTypeId" onchange="loadEstimateData()"><option value="0">--Select Resource Type--</option></select></div>
															
											</td>
											
											<td width="25%">Res Code</td>
											<td width="25%">
											<div id="resourceCodes"><select name="resourceCodeId" id="resourceCodeId" ><option value="0">--Select--</option></select></div>
											...
											<td  width="25%" ><input type="text" name="resourceName" id="resourceName" readOnly="true"/></td>
											<td  width="25%" >Tollerance</td>
											<td  width="25%"><input type="text" name="tollerance" id="tollerance" readOnly="true"/></td>
											</tr>
											<tr>
											<td  width="25%">Estimate Quantity</td>
											<td  width="25%"><input type="text" name="estiQuantity" id="estiQuantity" value=""  onchange="calculateTotal(this);"/></td>
											<td  width="25%">Total Cost</td>
											<td  width="25%"><input type="text" name="totalCost"  id="totalCost" readOnly="true"/></td>
											</tr>
											<tr>
											<td  width="25%">Unit Price</td>
											<td  width="25%"><input type="text" name="unitPrice"  id="unitPrice" readOnly="true"/></td>
											<td  width="25%"></td>
											<td  width="25%"><input type="hidden" name="lineSectypeId"  id="lineSectypeId" /></td>
											</tr>
											
										</table>
										<input type="button" name="add" id="add" value="Add Items" onclick="addPegItems1();"/>
