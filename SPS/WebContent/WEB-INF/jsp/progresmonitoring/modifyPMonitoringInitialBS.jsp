		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						<s:form id="frmRevise" name="frmRevise" action="reviseJobBS!updateReviseDetails" method="POST"
										validate="true" theme="simple">
						  		<table align="center" class="tldFromContent1" width="100%">
						  			<tr>
								
									<td  width="25%">Application No</td>
									...
									<td  width="25%">Commecial Ref No</td>
									<td  width="25%"><input type="text" name="fileRef"  id="fileRef" "/></td>
									<td  width="25%">Commecial/Maintenance Ref No</td>
									<td  width="25%"><input type="text" name="fileRef"  id="fileRef" "/></td>
									...
									<td  width="25%">Area Code</td>
									<td  width="25%"><input type="text" name="fileRef"  id="fileRef" "/></td>
									</tr>
									<tr>
									<td  width="25%">Estimation By</td>
									<td  width="25%"><input type="text" name="fileRef"  id="fileRef" "/></td>
									
									<td  width="25%">Construction By</td>
									<td  width="25%"><input type="text" name="fileRef"  id="fileRef" "/></td>
									
									</tr>
									<tr>
									<td  width="25%">Est Cost</td>
									<td  width="25%"><input type="text" name="amount"  id="amount" onChange="validateQuantity(this)"/></td>
									
									
									<td  width="25%">Supervision By</td>
									<td  width="25%"><input type="text"  name="it" id="estimateDatePicker" readOnly="true"/></td>
									</tr>
									<tr>
									
									<td  width="25%">Job Assigned Date</td>
									<td  width="25%"><input type="text"  name="it1" id="pivDatePicker" readOnly="true"/></td>
									<td  width="25%">Target Date</td>
									<td  width="25%"><input type="text"  name="it2" id="pivDatePicker" readOnly="true"/></td>
									</tr>
									<tr>
									<td  width="25%">Job No Received No</td>
									<td  width="25%"><input type="text"  name="it3" id="pivDatePicker" readOnly="true"/></td>
									<td  width="25%">Project Letter Received On</td>
									<td  width="25%"><input type="text"  name="it4" id="pivDatePicker" readOnly="true"/></td>
									
									</tr>
									<tr>
									<td  width="25%">Estimate Recieved on</td>
									<td  width="25%"><input type="text"  name="it6" id="pivDatePicker" readOnly="true"/></td>
									<td  width="25%">Estimate Sent To DGM On</td>
									<td  width="25%"><input type="text"  name="it7" id="pivDatePicker" readOnly="true"/></td>
									
									</tr>
									
									<tr>
									<td  width="25%">Project Letter to Es On</td>
									<td  width="25%"><input type="text"  name="it5" id="pivDatePicker" readOnly="true"/></td>
								...
								<table>
									<tr>
										<td>HT33</td>
										<td><input type="text" name="ht33"  id="ht33"/></td>
										<td>LT3Phase</td>
										<td><input type="text" name="lt3phase"  id="lt3phase" /></td>
										<td>ABC5W</td>
										<td><input type="text" name="abc5w"  id="abc5w" /></td>
									</tr>
									<tr>
										<td>HT11</td>
										<td><input type="text" name="ht33"  id="ht33" /></td>
										<td>LTSPhase</td>
										<td><input type="text" name="ltsphase"  id="ltsphase" /></td>
										<td>ABC4W</td>
										<td><input type="text" name="abc4w"  id="abc4w"/></td>
									</tr>
									<tr>
										<td>SUB33</td>
										<td><input type="text" name="sub33"  id="sub33"/></td>
										<td>LT1->3</td>
										<td><input type="text" name="lt13"  id="lt13"/></td>
										<td>ABC SECCC</td>
										<td><input type="text" name="abcseccc"  id="abcseccc"/></td>
									</tr>
									<tr>
										<td>SUB11</td>
										<td><input type="text" name="sub11"  id="sub11"/></td>
										<td>SUB CAP</td>
										<td><input type="text" name="subcap"  id="subcap"/></td>
										<td>ABC SECCC</td>
										<td><input type="text" name="abcseccc"  id="abcseccc"/></td>
									</tr>
									<tr>
										<td><input type="checkbox" name="isAugSub"  id="isAugSub"/></td>
										<td>Pre Capacity</td>
										<td><input type="text" name="preCapacity"  id="preCapacity"/></td>
										<td>New Capacity</td>
										<td><input type="text" name="newCapacity"  id="newCapacity"/></td>
										<td></td>
									</tr>
									<tr>
									<td><s:submit theme="simple" value="Print Revise Estimate Report" method="PrintReviseEstimateReport" id="btnprint1" ></s:submit>
									</td>
									<td><s:submit theme="simple" value="Exit" method="close" id="btnClose" ></s:submit></td>
									<td><s:submit theme="simple" value="Update" method="revise" id="revise" onclick="return validateForm()"></s:submit></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									</tr>
