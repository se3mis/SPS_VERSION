...
&nbsp;&nbsp;
												...
												<%int i=0; %>
												<s:iterator value="rejectedWorkEList">
													<tr bgcolor="#CCCCCC">													
													
														<s:url id="page_url" namespace="/estimate/web" action="pegSchedule!undoReject">
														...
														<td align="left"><s:property value="rejctUid" /></td>
														<td align="left"><s:text name="format.date" ><s:param value="rejctDt"/></s:text> </td>
														<td align="left"><s:property value="rejectReason" /></td>
