				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form name="changePivIdNo" action="changePivIdNo" method="POST"
												...
												<tr>
													...
													<table width="100%" class="tldFromContent" border="0" >
														...
														<tbody>
															...
															<tr>
																<td></td>
																<td><s:label value="Piv No"></s:label>
																	<s:textfield name="pivNo" id="txfdPivNo" size="24" maxlength="24" onblur="javascript:{this.value = this.value.toUpperCase(); }"></s:textfield><s:submit theme="simple" align="right" value="Find" method="findPivNo" id="btnFindPivNo" onclick="return checkAppIdNoNotNull()"></s:submit></td>
																<td></td>
																<td></td>
															</tr>
														   <tr>
