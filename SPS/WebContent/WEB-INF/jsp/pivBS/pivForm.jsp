																...
																<table  width="100%" class="tldFromContent" border="0">
																	...
																	<tbody>
																		...
																		<tr>
																			...
																			<td><s:textfield name="chequeNo" id="txfdChequeNo" size="8" maxlength="8" onkeypress="return onlyNumbers(event)"></s:textfield></td>
																		</tr>
																		<tr>
																			<td><s:label value="Amount Allocated"></s:label></td>
																			<td><s:textfield name="loanAmount" id="txfdAllocatedChecAmount" size="20" onkeypress="return onlyNumbers(event)"></s:textfield></td>
																		</tr>
																		<tr>
