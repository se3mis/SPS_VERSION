...
function submitForm()
{
	document.forms["LabourActivityMasterList"].submit();
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="LabourActivityMasterList" method="POST"
										validate="true" theme="simple" name="LabourActivityMasterList">
											...
											<tr>
												<td colspan="3"> 
												 <table class="tldFromContent" border="1">
													...
													<tr bgcolor="#93C9FF">
													<td>
														<strong>Activity Code</strong></td>
