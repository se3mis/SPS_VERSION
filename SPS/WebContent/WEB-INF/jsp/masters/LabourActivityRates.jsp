...
<title>Add new Labour Activity Rates</title>
...
function submitForm()
{
	document.forms["AddNewLabourActivity"].submit();
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="NewLabourActivity" method="POST"
										validate="true" theme="simple" name="AddNewLabourActivity">
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												<td class="listHeader" colspan="9">
												<table width="118%" border="0">
													<tr>
														<td width="26%" class="listHeader" >New Labour Activity Rate</td>
											...
											<tr>
												...
												<td ><s:select list="applicationTypeList"
													...
													name="selectedApplicationType" onchange="submitForm();"></s:select></td>
											</tr>
											<tr>
												<td width="18%">Labour Code<font color="red">*</font></td>
												<td width="1%">:</td>
												<td width="81%"> <s:textfield id="labourCode" name="labourCode" size="50" ></s:textfield> </td>
											</tr>
											<tr>
												<td>Department ID</td>
												<td>:</td>
											...
											<tr>
												<td colspan="3"><s:submit  theme="simple" type="submit"
													value="Add Labour Activity Rates" method="AddLabourActivityRate"  >
												</s:submit>											
