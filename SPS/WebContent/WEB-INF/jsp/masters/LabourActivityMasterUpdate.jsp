...
function submitForm()
{
	document.forms["LabourActivityMasterUpdate"].submit();
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="LabourActivityMasterUpdate" method="POST"
										validate="true" theme="simple" name="LabourActivityMasterUpdate">
										<table width="100%" class="tldFromContent" border="0">
											...
											<tr>
												<td width="18%">Activity Code </td>
												<td width="1%">:</td>
												<td width="81%"> <s:select list="activityCodeList"
													headerKey="-1" listValue="%{activityCode}"
													listKey="activityCode" emptyOption="false"
													name="selectedActivityCode" onchange="submitForm();"></s:select></td>
											</tr>
											<tr>
												<td>Activity Name </td>
												<td>:</td>
											...
											<tr>
												<td colspan="3"><s:submit  theme="simple" type="submit"
													value="Add Labour Activity" method="UpdateLabourActivity"  >
												</s:submit>											
