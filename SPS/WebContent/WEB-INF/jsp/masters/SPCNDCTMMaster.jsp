...
<title>Conductor Type Material Master Detials</title>
...
function submitForm()
{
	document.forms["SPCNDCTMForm"].submit();
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="loadSPCNDCTMPage" method="POST"
										validate="true" theme="simple" name="SPCNDCTMForm">
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												<td class="listHeader" colspan="9">
												<table width="118%" border="0">
													<tr>
														<td width="26%" class="listHeader" >Conductor Type Material Master
														Details</td>
											...
											<tr>
												...
												<td>:</td>
												<td><s:select list="conductorTypesList"
													name="selectedConductorType" onchange="submitForm();"></s:select></td>
											</tr>
											<tr>
