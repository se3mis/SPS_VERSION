				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="LAStay" method="POST"
										validate="true" theme="simple" name="LAStay">
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												<td class="listHeader" colspan="9">
												<table width="118%" border="0">
													<tr>
														<td width="26%" class="listHeader" >Stay Rates</td>
												...
												<td colspan="3"> 
												 <table class="tldFromContent" border="1">
													...
													<s:iterator value="viewList">
														...
														<td> <s:property  value="stayType" /></td>
