				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="loadSPCSTPage" method="POST"
										...
										<table width="100%" class="tldFromContent" border="0">
											...
											<tr>
												<td>From Length</td>
												<td>:</td>
												<td><s:select list="fromLengthList"
													name="selectedFromLength" onchange="submitForm();"></s:select>
												</td>
											</tr>
											<tr>
												<td>To Length</td>
												<td>:</td>
												<td><s:select list="toLengthList"
													name="selectedToLength" onchange="submitForm();"></s:select>
												</td>
											</tr>
											<tr>
												<td>Tarrif Category</td>
												<td>:</td>
												<td><s:select list="tarrifCategoryList" headerKey="-1"
													listValue="%{tariffName}" listKey="tariffCode"
													emptyOption="false" name="selectedTarrifCategory"
											...
											<tr>
												...
												<td>:</td>
												<td><s:textfield name="securityDeposite" size="15" onblur="numericValidate(this,event);formatValue(this)"  onkeyup="numericValidate(this,event)"></s:textfield>
												</td>
											</tr>
											<tr>
												<td>Temporary Deposit</td>
												<td>:</td>
												<td><s:textfield name="temporaryDeposite" size="15" onblur="numericValidate(this,event);formatValue(this)"  onkeyup="numericValidate(this,event)"></s:textfield>
												</td>
											</tr>											
											...
											<tr>
												<td colspan="3"><s:submit theme="simple" type="submit"
												 ...
												 <s:submit	theme="simple" align="right" value="Remove" type="submit"method="Remove"></s:submit>
