				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="LAStriningServiceWireList" method="POST"
										...
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												...
												<table width="118%" border="0">
													<tr>
														<td width="26%" class="listHeader" >Labour Activity Stringing Service Wire</td>
												...
												<td colspan="3"> 
												 <table class="tldFromContent" border="1">
													...
													<s:iterator value="viewList">
														...
														<td> <s:property  value="phase" /></td>
														<td> <s:property  value="conductorType" /></td>
