				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="loadTransferConstructionToAssets"
										...
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												...
												<table width="118%" border="0">
													<tr>
														<td width="33%" class="listHeader">Completed Construction Job Transfering To Assets</td>
										...
										<!--	<tr>
											...
											<tr>
												<td colspan="3"><s:submit theme="simple" type="submit"
													value="Download Letter" method="GenerateJobTransferToAsset">
