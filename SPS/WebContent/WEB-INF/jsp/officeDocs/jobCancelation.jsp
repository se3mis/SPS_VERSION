				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="loadJobCancelletion"
										...
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												...
												<table width="118%" border="0">
													<tr>
														<td width="33%" class="listHeader">Job Cancellation</td>
											...
											<tr>
												<td>Reason to Cancel the Job </td>
												<td>:</td>
												<td>
												<s:textfield name="reason" id="reason" size="150" ></s:textfield>
												<!-- <div id="ContractorList">
													<select name="contractor" id="contractor" ><option value="-1">--Select--</option>
													</select>
												</div> -->
											...
											<tr>
												<td colspan="3"><s:submit theme="simple" type="submit"
													value="Download Letter" method="GenerateJobCancellation">
