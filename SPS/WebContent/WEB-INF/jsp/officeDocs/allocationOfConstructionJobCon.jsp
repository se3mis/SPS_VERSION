				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="loadAllocationOfConstructionJobCon"
										...
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												...
												<table width="118%" border="0">
													<tr>
														<td width="33%" class="listHeader">Allocation of Construction Job</td>
											...
											<tr>
													...
													<s:if test="%{costCenter=='510.20' || costCenter=='530.80' || costCenter=='530.20' || costCenter=='530.30'}">
														<s:textfield name="construcRef" id="construcRef" size="50"></s:textfield>
											...
											<tr>
												<td colspan="3"><s:submit theme="simple" type="submit"
													value="Download Letter" method="GenerateAllocationOfConstructionLetterCon">
