...
function submitForm()
{
	document.forms["consumerEnergize"].submit();
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="loadConsumerEnergizePage"
										method="POST" validate="true" theme="simple" name="consumerEnergize">
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												<td class="listHeader" colspan="9">
												<table width="118%" border="0">
													<tr>
														<td width="33%" class="listHeader">Consumer Energize</td>
											...
											<tr>
												<td>Energize Date</td>
												<td>:</td>
												<td><sx:datetimepicker name="visitedDate"
													displayFormat="yyyy-MMM-dd"  required="true" /></td>
											</tr>
