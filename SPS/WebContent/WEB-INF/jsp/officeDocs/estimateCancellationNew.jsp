				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="estmateCancellationNew"
										...
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												...
												<table width="118%" border="0">
													<tr>
														<td width="33%" class="listHeader">Help </td>
										...
										<!--	<tr>
											...
											<tr>
											    <td width="35%">
												<s:label value="Download Help For Circuler No : 2015/DCC/COM-3" ></s:label>
												</td>
												<td width="35%">
												<s:submit theme="simple" type="submit"	value="Download" method="GenerateHelpCirculerNoCOM3"></s:submit>
												</td>
											</tr>
											 
											<tr>
											    <td width="35%">
												<s:label value="Download Help For Estimate Cancellation Commercial" ></s:label>
												</td>
												<td width="35%">
												<s:submit theme="simple" type="submit"	value="Download" method="GenerateHelpEstimateCancellationNew"></s:submit>
												</td>
											</tr>
											<tr>
											    <td width="35%">
												<s:label value="Download Help For Change Post Dept ID and Status Commercial" ></s:label>
												</td>	
												<td width="35%">
												<s:submit theme="simple" type="submit"	value="Download " method="GenerateHelpChangePostDeptIDandStatus"></s:submit>
												</td>
											</tr>
											<tr>
											    <td width="35%">
												<s:label value="Download Help For Upload Sketch Commercial" ></s:label>
												</td>	
												<td width="35%">
												<s:submit theme="simple" type="submit"	value="Download " method="GenerateHelpUploadSketch"></s:submit>
												</td>
											</tr>
											<tr>
											    <td width="35%">
											...
											<tr>
											    <td width="35%">
												<s:label value="Download Help For Change Code Number Construction" ></s:label>
												</td>	
												<td width="35%">
												<s:submit theme="simple" type="submit"	value="Download " method="GenerateHelpChangeCodeNumber"></s:submit>
												</td>
											</tr>
											
											<tr>
											    <td width="35%">
												<s:label value="Download Help For Add Rebate Material Construction" ></s:label>
												</td>	
												<td width="35%">
												<s:submit theme="simple" type="submit"	value="Download " method="GenerateHelpAddRebateMaterial"></s:submit>
												</td>
											</tr>
											
											<tr>
												<td >
												<s:submit theme="simple" align="right" value="Exit" type="submit" method="Exit" id="btnClose"></s:submit>
												</td>
											</tr>
