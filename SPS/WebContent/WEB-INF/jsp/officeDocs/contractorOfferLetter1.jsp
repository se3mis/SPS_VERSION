...
<title>Contractor Offer Letter</title>
...
function loadAllocatedIdsContarctorOfferLetter(estimateNo){
	$("#constructionEstimate select option:gt(0)").remove();
	$("#allocatedIDs select option:gt(0)").remove();
	 $.getJSON("sps/loadAllocatedIdsContarctorOfferLetter.ajax?ApplicationNumber="+estimateNo.value, {ajax_command:"loadAllocatedESListForContractorLetter",ajax_ieCacheFix:new Date().getTime()}, function(json) {
										...
										<table width="100%" class="tldFromContent" border="0">
											...
											<tr>
												...
												<div id="applicationRefs1">
													<select name="selectedEstNumber" id="selectedEstNumber" onchange="loadAllocatedIdsContarctorOfferLetter(this)"><option value="-1">--Select--</option>
													</select>
												</div>
											...
											<tr>
												...
												</div><s:textfield name="construcRef" size="50"></s:textfield>
												</td>
											</tr>
											...
											<tr>
												...
												<td>:</td>
												<td>
												<s:textfield name="contractor" size="50"></s:textfield>
											...
											<tr>
													...
													<td>:</td>
													<td>
													<s:textfield name="allocatedId" size="50"></s:textfield>
													<!-- <div id="allocatedIDs">
											...
											<tr>
												...
												<td width="1%">:</td>
												<td width="81%"><s:textfield name="jobNumber" size="50"></s:textfield>
												</td>
											</tr>
											<!--  <tr>
												<td>Work Scope</td>
											...
											<tr>
												<td colspan="3"><s:submit theme="simple" type="submit"
													value="Download Letter" method="GenerateContracOfferLetter">
