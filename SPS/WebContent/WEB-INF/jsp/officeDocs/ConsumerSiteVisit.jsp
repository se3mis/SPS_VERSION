...
function submitForm()
{
	document.forms["consSiteVisitForm"].submit();
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="loadconsumerVisitingPage"
										method="POST" validate="true" theme="simple" name="consSiteVisitForm">
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												<td class="listHeader" colspan="9">
												<table width="118%" border="0">
													<tr>
														<td width="33%" class="listHeader">Consumer Site Visiting Letter</td>
											...
											<tr>
												...
												<td>:</td>
												<td>
												 <s:property value="visitingDate" />
												<s:hidden name="visitingDate" value="%{visitingDate}" />
											...
											<tr>
												<td>Session</td>
												<td>:</td>
												<td><s:select list="sessionList" name="selectedSession"></s:select>
												</td>
											</tr>
											...
											<tr>
												<td colspan="3">
												<s:submit value="Download Letter" method="generate"></s:submit>
												
												  <s:submit theme="simple" align="right" value="Exit"
													type="submit" method="Exit" id="btnClose"></s:submit>
												</td>
