				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="summaryofInProgressConstructionNew"
										...
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												...
												<table width="118%" border="0">
													<tr>
														<td width="33%" class="listHeader">Summary Of InPrograss Jobs</td>
										...
										<!--	<tr>
											...
											<tr>
												<td colspan="3"><s:submit theme="simple" type="submit"
													value="Download Report" method="GenerateSummaryofInProgressConstructionNew">
