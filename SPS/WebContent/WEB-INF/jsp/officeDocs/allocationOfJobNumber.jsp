				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="loadAllocationJobNumber"
										...
										<table width="100%" class="tldFromContent" border="0">
											<tr>
												...
												<table width="118%" border="0">
													<tr>
														<td width="33%" class="listHeader">Allocation of Job Number</td>
											...
											<tr>
												...
												<s:submit theme="simple" type="submit"
													value="Download Letter" method="GenerateAllocationOfJobLetter">
													</s:submit>
													
												<s:submit theme="simple" type="submit"
													value="Download Letter AU" method="GenerateAllocationOfJobLetterAU">
													</s:submit>
												<s:submit theme="simple" type="submit"
													value="Download Letter -Planning" method="GenerateAllocationOfJobLetterPlanning">
													</s:submit>
													<s:submit theme="simple" type="submit"
													value="Download Letter -Below One Million" method="GenerateAllocationOfJobLetterBelowOneMillion">
													</s:submit>
