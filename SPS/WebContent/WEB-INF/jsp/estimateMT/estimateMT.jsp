...
<script type="text/javascript" src="../../script/estimateMT.js"> </script>
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="0" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form id="frmEstimate" name="frmEstimate" action="estimateMT" method="POST"
										...
										<table width="75%" class="tldFromContent" border="0">
											...
											<tbody>
												<tr>
													...
													<s:if test="%{isViewOnly == 'true'}">
													VIEW STANDARD ESTIMATION
													</s:if>
													<s:elseif test="%{isModify=='true'}">
													MODIFY STANDARD ESTIMATION
													</s:elseif>
													<s:elseif test="%{isUndoReject=='true'}">
													UNDO REJECTED ESTIMATION
													</s:elseif>
												...
												<tr height="20">
													<td colspan="2">
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Temp Id : <s:property value="applicationId" /><s:hidden name="applicationId" id="applicationId"></s:hidden>	
													</td>
												</tr>
												<tr height="20">
													<td colspan="2">
													Cost Center : <s:property value="costCenterNo" /><s:hidden name="costCenterNo" id="costCenterNo"></s:hidden>
												...
												<tr>
													...
													<table width="100%" border="0">
														...
														<tr height="20">
															...
															<s:property  value="applicantName"  /><s:hidden id="applicantName" name="applicantName"/>
														...
														<tr height="20">
															...
															<td>:</td>
															<td><s:property  value="idNo"  /><s:hidden id="idNo" name="idNo"/>	 </td>
														...
														<tr height="20">
															...
															<td><s:if test="description!=NULL">
																...
																</s:if> <s:hidden id="description" name="description"/>
															</td>
														</tr>
														<tr height="20">
												...
												<s:if test="%{isViewOnly!='true' && isModify!='true' && isUndoReject!='true' && estimateExist != 'true' && isApprove!='true' && isPrint!='true'}">
												<tr>
													<td>
													Copy estimate details from: <s:textfield name="copyEstimateNo" id="txtCopyEstimateNo" size="23" maxlength="21"></s:textfield>
													<s:submit theme="simple" align="right" value="Fill"	method="copyEstimateDetails" 
													onclick="return checkCopy()" id="btnFill"></s:submit>
													</td>
												</tr>
												</s:if>
												<tr>
												...
												<tr>
													...
													<table width="100%" border="0">
														...
														<tr>
															...
															<td>:</td>
															<td><s:textfield name="lineLength" id="lineLength" onkeyup="show_estcost();numericValidate(this,event);" onblur="show_estcost();"   readonly="true"/></td>
														</tr>
														<tr>
													...
													<s:hidden id="isPoleMatParamClicked" name="isPoleMatParamClicked"></s:hidden>
													...
													<td valign="top">
														<table border="0">
															...
															<tr>
																...
																<td>
																	<s:url id="estcost_url" value="estimateMT!calEstCostToLineLen" />
														...
														<table  width="100%" >
															...
															<tr>
																...
																<s:if test="isViewApplicant!=null">
																	<s:url id="add_url" value="MaterialActionMT!addMaterials" />
																	<s:url id="display_url" value="MaterialActionMT!displayMaterials" />
																	<table width="100%">
																		<tr>
																			<td>
																				<sx:div id="selMat" theme="simple" href="%{add_url}" listenTopics="add_mat" formId="frmEstimate" ></sx:div>
																				
																				<s:url id="add_cost_url" value="MaterialActionMT!addOtherCost" />
																				<s:url id="add_nplcost_url" value="MaterialActionMT!addNPLMatCost" />
																				<s:url id="add_polemat_url" value="MaterialActionMT!addPoleMaterials" />
																				<s:url id="lab_cost_url" value="MaterialActionMT!calLabourCost" />
																				<s:url id="refresh_mat_url" value="MaterialActionMT!refreshSelectMat" />
																				...
																				<sx:bind targets="selMat" sources="addPoleMatLink" events="href" href="%{#add_polemat_url}" listenTopics="add_pole_mats" formId="frmEstimate" />
																		...
																		<tr>
																			<td>
																				<!-- remove -->
																				<s:url id="remove_url" value="MaterialActionMT!removeMaterials" />
																		...
																		<tr>
																			<td>
																				<s:a href="javascript:show_pole_mat_params()">Add Poles with Materials</s:a>
																				&nbsp;&nbsp;&nbsp;
																				<s:a id="showLink" href="javascript:show_materials()">Add Other Materials</s:a>
																				&nbsp;&nbsp;&nbsp;
																		...
																		<tr>
																			<td align="center">
																				<s:url id="oth_cost_url" value="MaterialActionMT!displayOtherCost" />
																				<sx:div id="others" href="%{#oth_cost_url}" listenTopics="display_oth_cost" formId="frmEstimate" />
																			</td>
																		</tr>
																		<tr>
																			<td align="center">
																				<s:url id="polematparam_url" value="MaterialActionMT!displayPoleMaterialParams" />
																				<sx:div id="poleMatParam" href="%{#polematparam_url}" listenTopics="display_pole_mat_param" formId="frmEstimate" />
																				<br><br>
																		...
																		<tr>
																			<td align="center">
																				<s:url id="npl_cost_url" value="MaterialActionMT!displayNPLMatCost" />
