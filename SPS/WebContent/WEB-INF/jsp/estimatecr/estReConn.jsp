...
VIEW ESTIMATION (RE-CONNECTION)
</s:if>
<s:elseif test="%{isModify=='true'}">
MODIFY ESTIMATION (RE-CONNECTION)
</s:elseif>
<s:elseif test="%{isUndoReject=='true'}">
UNDO REJECTED ESTIMATION (RE-CONNECTION)
</s:elseif>
<s:elseif test="%{isPrint=='true'}">
PRINT ESTIMATION (RE-CONNECTION)
</s:elseif>
<s:elseif test="%{isApprove=='true'}">
APPROVE/REJECT ESTIMATION (RE-CONNECTION)
</s:elseif>
<s:else>NEW ESTIMATION (RE-CONNECTION)</s:else>
</title>
...
{
	document.getElementById('isMatQtyEntered').value = "true";
	dojo.event.topic.publish("display_estcost");
	document.getElementById('isMatQtyEntered').value = "";
}
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="0" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form id="frmEstimate" name="frmEstimate" action="estreconn" method="POST"
										...
										<s:hidden id="overheadRate" name="overheadRate"></s:hidden><s:hidden id="isAddLabClicked" name="isAddLabClicked"></s:hidden>
										...
										<s:hidden id="crType" name="crType" value="CR"></s:hidden>
										...
										<table width="75%" class="tldFromContent" border="0">
											...
											<tbody>
												<tr>
													...
													<s:if test="%{isViewOnly == 'true'}">
													VIEW STANDARD ESTIMATION (RE-CONNECTION)
													</s:if>
													<s:elseif test="%{isModify=='true'}">
													MODIFY STANDARD ESTIMATION (RE-CONNECTION)
													</s:elseif>
													<s:elseif test="%{isUndoReject=='true'}">
													UNDO REJECTED ESTIMATION (RE-CONNECTION)
													</s:elseif>
													...
													<s:else>
													NEW STANDARD ESTIMATION (RE-CONNECTION)
													</s:else>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<table width="100%" border="0">
														...
														<tr height="20">
															<td>Finalised within</td>
															<td>:</td>
															<td><s:property value="disconnectDur" default="" /><s:hidden id="disconnectDur" name="disconnectDur"/></td>
														</tr>
														<tr>
													...
													<s:hidden id="isMatQtyEntered" name="isMatQtyEntered"></s:hidden>
													...
													<td valign="top">
														<table border="0">
															...
															<tr>
																...
																<td>
																	<s:url id="estcost_url" value="estreconn!calEstCostToLineLen" />
										...
										<table>
											<tr>
												...
												<s:if test="isViewApplicant!=null">
													...
													<s:submit theme="simple" value="Print" id="btnPrint" onclick="javascript:printingReConn()" type="button" ></s:submit>
												</s:if>
												<s:else>
