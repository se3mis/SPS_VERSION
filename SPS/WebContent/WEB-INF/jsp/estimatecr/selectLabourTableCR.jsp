...
<table class="tldFromContent"  border="1" width="100%">
	...
	<tr>
		<s:hidden name="labourCodeList" id="labourCodeList" ></s:hidden>
		<s:hidden name="labourDescList" id="labourDescList" ></s:hidden>
		<s:hidden name="labourPriceList" id="labourPriceList" ></s:hidden>
		<s:hidden name="labourUomList" id="labourUomList" ></s:hidden>
		<s:hidden name="labourQtyList" id="labourQtyList" ></s:hidden>
		<s:hidden name="labourCostList" id="labourCostList" ></s:hidden>
		<s:if test="%{isUndoReject != 'true'}">
