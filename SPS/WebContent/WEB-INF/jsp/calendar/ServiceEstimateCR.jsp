...
<title>Service Estimation CR</title>
<link rel="stylesheet" type="text/css" href="../../style/style.css" />
<script type="text/javascript" src="../../script/serviceEstimateCR.js"> </script>
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="serviceEstimateCR" method="POST"
													...
													<table width="60%" class="tldFromContent" border="1">
														<tbody>
															...
															<tr>
																...
																<td><s:textfield name="noOfSpans" id="noOfSpans"
															...
															<tr>
																...
																<td><s:textfield name="distancetoServicePlace" id="txtdistancetoServicePlace"
																	size="8" readonly="true" onkeypress="return restrictToTwoDecimalPossition(this,event);"></s:textfield></td>
																<td></td>
																<td></td>
																<td></td>
																<td></td>
													...
													<table width="100%" class="tldFromContent" border="0">
														...
														<tbody>
															...
															<tr>
																...
																<td><s:textfield name="sin" id="txfdsin" size="20"
																	readonly="true"></s:textfield></td>
																<td></td>
															</tr>
															<tr>
															...
															<tr>
																<td></td>
																<td style="visibility: hidden;" id="tdLableIsConversion"><s:label value="Is Conversion"></s:label></td>
																<td style="visibility: hidden;" id="tdRadioIsConversion"><s:radio name="isConversion" id="RadiowireisConversion"
