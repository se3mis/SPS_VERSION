				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="0" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form id="frmEstimate" name="frmEstimate" action="billingErrors" method="POST"
												...
												<s:hidden name="costCenterNo"></s:hidden>
													<td colspan="2">
														<table  width="100%">
															<tr>
															<td width="5">&nbsp;</td>
															<td class="tdHeadings">SMC Erros.(5 at a time)</td>
														</tr>
															<tr>
																<td width="5">&nbsp;</td>
																<td>
																			...
																			<td>
																				<s:if test="errorList!=null">
																					<table class="tldFromContent"  border="1" width="100%">
																						...
																						<%int i=0; %> 
																						<s:iterator value="errorList"  id="listColumnStyle">
																							<tr height="20">
