		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						<s:form id="frmRevise" name="frmRevise" action="softclosePE" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<td  width="25%">
									<s:submit theme="simple" value="Send to Accounts Branch " method="softClosePE" id="softClosePE" onclick="return validateForm()"></s:submit>
									<s:submit theme="simple" value="Reject" method="rejectPE" id="rejectPE" onclick="return validateForm()"></s:submit>
