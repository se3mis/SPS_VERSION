...
//alert(json.estimateDetails.length);			
			...
			$('#previousTotalCost').val(intToFormat(json.previousTotalCost));
			...
			$('#variance').val(json.variance);
				...
				$.each(json.estimateDetails,function(i,estimateDetail){
						...
						var estimateDetails = '<tr  id="lineseciid'+estimateDetail.resourceCode+'">'+	
										...
										'<td id="estimatedQuantityBefore'+estimateDetail.resourceCode+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetail.estimatedQuantityBefore+'" id="'+estimateDetail.estimatedQuantityBefore+'"  maxlength="10" size="10" readonly="true" value="'+estimateDetail.estimatedQuantityBefore+'"/></td>'+
										'<td id="estQuanDif'+estimateDetail.resourceCode+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetail.estQuanDif+'" id="'+estimateDetail.estQuanDif+'"  maxlength="10" size="10" readonly="true" value="'+estimateDetail.estQuanDif+'"/></td>'+
										
										//if(estimateDetail.estQuanDif == 0){
											//'<td id="estQuanDif'+estimateDetail.resourceCode+'" align="left" ><input type="text" class="required" style="text-align: right;color: green;" name="'+estimateDetail.estQuanDif+'" id="'+estimateDetail.estQuanDif+'"  maxlength="10" size="10" readonly="true" value="'+estimateDetail.estQuanDif+'"/></td>'+
											
										//}else{
											//}
										'<td align="left" ><input type="text" class="required" style="text-align: right;color: green;"  name="estimateCost"  id="estimateCost'+estimateDetail.resourceCode+'"  maxlength="10" readonly="true" size="10" value="'+estimateDetail.estimateCost+'"  /></td>'+
					...
					<tr  class="tblInner">
						...
						<s:form id="frmRevise" name="frmRevise" action="reviseJobBS!ReviseValidationBS" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<td  width="25%">
									<s:if test="%{loggedInUserLevel=='CE' || loggedInUserLevel=='DGM' || ( loggedInUserLevel=='EE' && costCenterNo==543.10)}"> 
											<s:submit theme="simple" value="Approve" method="approve" id="Validate" ></s:submit>
											<!--This will be done fuction same as approve after this fuction job will be showing to the MITFIN -->
									        <!--<s:submit theme="simple" value="Reject" method="app_rejected" id="Validate" ></s:submit>-->
									...
									<s:elseif test="%{loggedInUserLevel=='EE' || loggedInUserLevel=='CE' || loggedInUserLevel=='PE' || loggedInUserLevel=='ES'}">
										...
										<!--<s:submit theme="simple" value="Validate" method="approve" id="Validate" ></s:submit>-->
										<!--as requested by ce wps I reject function name change as modify -->
										<s:submit theme="simple" value="Modify" method="reject" id="Reject" ></s:submit>
							...
							<tr >
								<td colspan="3">
									...
									<table  class="tldFromContent1" id="estimateDetails"  style="display:block;" border="1"> 
							  			<tr id="header1">
											 <th><b>Resource CD&nbsp;&nbsp;</b></th><th><b>Resource Name&nbsp;&nbsp;</b></th><th><b>UOM&nbsp;&nbsp;</b></th><th><b>Unit Price&nbsp;&nbsp;</b></th><th><b>Estimated Quantity&nbsp;&nbsp;</b></th><th><b>Est Qua Before Revise&nbsp;&nbsp;</b></th><th><b>Revise Qty&nbsp;&nbsp;</b></th><th><b>Estimated Cost&nbsp;&nbsp;</b></th><th></th></tr>
