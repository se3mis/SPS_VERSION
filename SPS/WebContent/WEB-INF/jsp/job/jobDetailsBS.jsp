		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						<s:form id="frmRevise" name="frmRevise" action="jobBS!init" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<td  width="25%"><input type="text" name="estimateNo"  id="estimateNo" "/></td>
									</tr>
									<tr>
									...
									<s:submit theme="simple" value="Print Estimate Report" method="PrintReviseEstimateReport" id="btnprint1" >
									</s:submit>
									<s:submit theme="simple" value="Print Original Estimate" method="PrintOriginalEstimateReport" id="btnprint2" >
									</s:submit>							
