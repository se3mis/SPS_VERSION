		...
		<tr>
			...
			<table id="tblInner" class="tblInner" >
				<tbody>
					...
					<tr  class="tblInner">
						<td>
						<s:form id="frmRevise" name="frmRevise" action="reviseJobBS!updateReviseModifyDetails" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<td  width="25%">
									<s:submit theme="simple" value="Update" method="updateRevise" id="revise" onclick="return validateForm()"></s:submit>
									<!--<s:submit theme="simple" value="Update" method="RevisePrice" id="reviseprice" onclick="return validateForm()"></s:submit>-->
									<s:submit theme="simple" value="Print Revise Estimate Report" method="PrintReviseEstimateReport" id="btnprint1" ></s:submit>
									<s:submit theme="simple" value="Print Revise Est(A4)" method="PrintEstimateA4" id="btnprint2" ></s:submit>
