...
<title>Forced Job Close</title>
<link rel="stylesheet" type="text/css" href="../../style/style.css" />
<script type="text/javascript" src="../../script/ForcedJobClose.js"></script>
<s:head  />
<sx:head />
</head>
<body onload="on_Load()">
		 ...
		 <td>
			<table id="tblInner" class="tblInner">
				<tbody>
					...
					<tr>
						<td id="tdContent"><s:form action="forceJobCloseBS"  method="post"   theme="simple">
								...
								<tr>
									<td>
													<table width="100%" class="tldFromContent" border="0">
														...
														<tbody>
															...
															<tr>
																...
																<td><sx:datetimepicker name="appointmentDate" id="datepicker" displayFormat="dd/MM/yyyy"  required="true"  /></td>   																														
													...
													<td id="tdBotton" colspan="3">
														<s:submit theme="simple" value="Forced Job Close" method="forcedjobclose"  id="btnforcedjobclose" onclick="return validate_form()"></s:submit>
