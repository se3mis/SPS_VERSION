				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="0" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form id="frmEstimate" name="frmEstimate" action="accNoInfo" method="POST"
												...
												<s:hidden name="costCenterNo"></s:hidden>
													<td colspan="2">
														<table  width="100%">
															<tr>
															<td width="5">&nbsp;</td>
															<td class="tdHeadings">Account Nos.</td>
														</tr>
															<tr>
																<td width="5">&nbsp;</td>
																<td>
																				...
																				<s:if test="accNoList!=null">
																					<table class="tldFromContent"  border="1" width="100%">
																						<tr height="20">
																							...
																							<th>CSC No</th>
																							<th>Account No</th>
																							<th>Acc Created Date</th>
																						</tr>
																						<%int i=0; %> 
																						<s:iterator value="accNoList"  id="listColumnStyle">
																							<tr height="20">
																								<s:hidden name="accNoList" value="%{projectNo}"></s:hidden>
																								<td align="center">
																								...
																								<td><s:property value="accCreatedDate" /></td>
															...
															<tr>
																...
																<td>
																	<s:if test="errorList!=null">
																		<s:if test="%{loggedInUserLevel!='DEO' && loggedInUserLevel!='EA'}"> 
																		 <s:submit theme="simple" value="To Send Again" method="toSendAgain" id="btnSave" onclick="return validate_form()"></s:submit>
																		</s:if>
																	</s:if>
																	<s:else>
