...
<script type="text/javascript" src="../../script/JobClose.js"></script>
<s:head  />
<sx:head />
</head>
<body onload="on_Load()">
		 ...
		 <td>
			<table id="tblInner" class="tblInner">
				<tbody>
					...
					<tr>
						<td id="tdContent"><s:form action="JobCloseBS"  method="post"   theme="simple">
									...
									<td>
												...
												<tr>
													<td id="tdBotton" colspan="3">
														...
														<s:submit theme="simple" value="Close Job" method="jobClose"  id="btnforcedjobclose" onclick="return validate_form()"></s:submit>
