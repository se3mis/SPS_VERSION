					...
					<tr>
						...
						<table class="tblContent" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr>
									<td>
										<s:form id="frmEstimate" name="frmEstimate" action="OrderCard" method="POST"	validate="true" theme="simple">
																...
																<tr>
																	...
																	<td>
																		<table width="100%" border="0">
																			...
																			<tr>
																				<td colspan="8">Job Number :<s:textfield name="jobNo"
																					id="txtJobNo" size="23" maxlength="21"
																					onblur="javascript:{this.value = this.value.toUpperCase(); }"></s:textfield>
																					<s:submit theme="simple" align="right" value="Find"
																					method="viewOrderCardDetails" id="btnFindApplicationNo"
																					onclick="return checkJobNoNotNull()"></s:submit>
																			...
																			<tr height="20">
																				...
																				<td><s:textfield name="oldAcct" id="oldAcct"  maxlength="10" readonly="true" size="10"/></td>
																			</tr>
																			<s:if test="%{jobType=='SMC'}">
																			<tr height="20">
																				<td>loanCode</td>
															...
															<tr>
																...
																<td>
																	<s:if test="isViewJob!=null">
																		<!--<s:if test="%{jobType=='CRJ'}">-->
																		<!--<s:submit theme="simple" value="CR job Finish" method="cRjobFinish" id="btnCRjobFinish" onclick="return formValidation()"></s:submit>-->
																		<!--</s:if>-->
