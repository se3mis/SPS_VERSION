...
//alert(json.estimateDetails.length);			
			...
			$('#currentTotalCost').val(intToFormat(json.currentTotalCost));
			$('#variance').val(json.variance);	
					...
					<tr  class="tblInner">
						...
						<s:form id="frmRevise" name="frmRevise" action="reviseJobBS!updateReviseDetails" method="POST"
						  		...
						  		<table align="center" class="tldFromContent1" width="100%">
									...
									<td  width="25%">
									<s:submit theme="simple" value="Update" method="revise" id="revise" onclick="return validateForm()"></s:submit>
									<s:submit theme="simple" value="Print Job Report" method="PrintReviseEstimateReport" id="btnprint1" ></s:submit>
