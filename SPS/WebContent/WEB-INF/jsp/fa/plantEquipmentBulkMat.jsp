							...
							<tbody>
								<tr>
									<td><s:form id="frmEstimate" name="frmEstimate"
										action="PlantEquipBulkMat" method="POST" validate="true" theme="simple">
														...
														<tr>
															...
															<td>
																...
																<s:if test="isViewApplicant!=null">
																	<s:url id="mat_url" value="PlantEquipBulkMat!displayMaterialList" />
																	<table width="100%">
																		<tr>
																			<td>
															...
															<td><s:if test="%{isViewOnly!='true'}">
																...
																<s:else>
																	<s:if test="isViewApplicant!=null">
																		...
																		<s:else>
																			<s:submit theme="simple" value="Transfer to P&E" method="peTransfer"
																				id="btnSave" ></s:submit>
																		</s:else>
																	</s:if>
																	<s:else>
