...
VIEW ESTIMATION - Temporary Connection (28 Days)
</s:if>
<s:elseif test="%{isModify=='true'}">
MODIFY ESTIMATION - Temporary Connection (28 Days)
</s:elseif>
<s:elseif test="%{isUndoReject=='true'}">
UNDO REJECTED ESTIMATION - Temporary Connection (28 Days)
</s:elseif>
<s:elseif test="%{isPrint=='true'}">
PRINT ESTIMATION - Temporary Connection (28 Days)
</s:elseif>
<s:elseif test="%{isApprove=='true'}">
APPROVE/REJECT ESTIMATION - Temporary Connection (28 Days)
</s:elseif>
<s:else>NEW ESTIMATION - Temporary Connection (28 Days)</s:else>
</title>
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="0" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form id="frmEstimate" name="frmEstimate" action="estimatecarnival" method="POST"
										...
										<s:hidden id="tcType" name="tcType" value="carnival"></s:hidden>
										...
										<table width="75%" class="tldFromContent" border="0">
											<tr>
												<td colspan="2" class="listHeader" colspan="4">
													<s:if test="%{isViewOnly == 'true'}">
													VIEW STANDARD ESTIMATION - Temporary Connection (28 Days)
													</s:if>
													<s:elseif test="%{isModify=='true'}">
													MODIFY STANDARD ESTIMATION - Temporary Connection (28 Days)
													</s:elseif>
													<s:elseif test="%{isUndoReject=='true'}">
													UNDO REJECTED ESTIMATION - Temporary Connection (28 Days)
													</s:elseif>
													...
													<s:else>
													NEW STANDARD ESTIMATION - Temporary Connection (28 Days)
													</s:else>
												</td>
											</tr>
											<tr>
												...
												<td valign="top">
													<table border="0">
														...
														<tr>
															...
															<td>
																<s:url id="estcost_url" value="estimatecarnival!calEstCostToLineLen" />
															...
															<tr>
																...
																<s:if test="isViewApplicant!=null">
																	...
																	<table width="100%">
																		...
																		<tr>
																			<td>
																				<s:url id="remove_url" value="MaterialAction!removeCarnivalMaterials" />
									...
									<s:if test="%{isPrint == 'true'}">
										<table>
											<tr>
												...
												<td>
													<s:form action="estimatecarnival">
