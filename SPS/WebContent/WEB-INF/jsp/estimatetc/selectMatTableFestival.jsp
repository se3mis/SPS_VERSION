...
<table class="tldFromContent"  border="1" width="100%">
	...
	<s:iterator value="selectMatList" status="matStatus">
		<tr>
			...
			<s:textfield  readonly="true" name="txtSelQty" maxlength="5" size="5" id="txtSelQty%{resCd}"  value="%{estimateQty}"  theme="simple" onkeypress="return restrictToTwoDecimalPossition(this,event);"  onkeyup="numericValidate(this,event);calculateMatCost('Sel','%{resCd}','%{unitPrice}')"  cssStyle="text-align:right" ></s:textfield>
			</s:if>
			<s:else><s:textfield name="txtSelQty" maxlength="5" size="5" id="txtSelQty%{resCd}"  value="%{estimateQty}"  theme="simple"  onkeypress="return restrictToTwoDecimalPossition(this,event);" onkeyup="numericValidate(this,event);calculateMatCost('Sel','%{resCd}','%{unitPrice}')"  cssStyle="text-align:right" ></s:textfield>
				</s:else>
			</td>
			<td  align="right">
