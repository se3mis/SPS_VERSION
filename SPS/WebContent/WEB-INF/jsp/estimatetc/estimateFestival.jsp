...
VIEW ESTIMATION - Temporary Connection (14 Days)
</s:if>
<s:elseif test="%{isModify=='true'}">
MODIFY ESTIMATION - Temporary Connection (14 Days)
</s:elseif>
<s:elseif test="%{isUndoReject=='true'}">
UNDO REJECTED ESTIMATION - Temporary Connection (14 Days)
</s:elseif>
<s:elseif test="%{isPrint=='true'}">
PRINT ESTIMATION - Temporary Connection (14 Days)
</s:elseif>
<s:elseif test="%{isApprove=='true'}">
APPROVE/REJECT ESTIMATION - Temporary Connection (14 Days)
</s:elseif>
<s:else>NEW ESTIMATION - Temporary Connection (14 Days)</s:else>
</title>
<link rel="stylesheet" type="text/css" href="../../style/style.css" />

<script type="text/javascript" src="../../script/estimatetc.js"> </script>
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="0" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form id="frmEstimate" name="frmEstimate" action="estimatefestival" method="POST"
										...
										<s:hidden id="tcType" name="tcType" value="festival"></s:hidden>
										...
										<table width="75%" class="tldFromContent" border="0">
											<tr>
												<td colspan="2" class="listHeader" colspan="4">
													<s:if test="%{isViewOnly == 'true'}">
													VIEW STANDARD ESTIMATION - Temporary Connection (14 Days)
													</s:if>
													<s:elseif test="%{isModify=='true'}">
													MODIFY STANDARD ESTIMATION - Temporary Connection (14 Days)
													</s:elseif>
													<s:elseif test="%{isUndoReject=='true'}">
													UNDO REJECTED ESTIMATION - Temporary Connection (14 Days)
													</s:elseif>
													...
													<s:else>
													NEW STANDARD ESTIMATION - Temporary Connection (14 Days)
													</s:else>
												</td>
											</tr>
											<tr>
																...
																<td>
																	<table width="100%" border="0">
																		<tr height="20">
																			...
																			<td width="2">:</td>
																			<td width="30%"><s:property  value="applicantName"  /><s:hidden id="applicantName" name="applicantName"/> </td>
											...
											<tr valign="top">
												...
												<td valign="top">
													<table border="0">
														...
														<tr>
															<td colspan="2">Standard Estimate</td>
														</tr>
														<tr>
															<td width="5">&nbsp;</td>
															<td>
																<s:url id="estcost_url" value="estimatefestival!calEstCostToLineLen" />
														...
														<tr>
															...
															<s:if test="%{isViewApplicant == 'true'}">
																<table width="100%">
																	...
																	<tr>
																		<td>
																			<s:url id="remove_url_labour" action="estimatetc1!removeLabour" />
																	...
																	<s:if test="%{isViewOnly!='true'}">
																		<s:if test="%{isApprove == 'true'}">
																			<s:if test="isViewApplicant!=null">
																				...
																				<!--</s:if>-->
																				<s:submit theme="simple" value="Reject" method="rejectEstimate" id="btnReject" onclick="return rejectValidate()"></s:submit>
																			</s:if>
																			<s:else>
									...
									<s:if test="%{isPrint == 'true'}">
										<table>
											<tr>
												...
												<td>
													<s:form action="estimatefestival">
