																			...
																			<thead>
																				<tr>
																					...
																					<tr>
																						...
																						<td><s:textfield name="schemaName" id="schemaName" readonly="true"></s:textfield>&nbsp;&nbsp;&nbsp;&nbsp;<s:textfield name="schemaExtention" id="schemaExtention" readonly="true"></s:textfield></td>
																						<td><s:label value="Proposer Name" ></s:label></td>
																						<td><s:textfield name="proposerName" id="proposerName" readonly="true"></s:textfield></td>
																					</tr>	
																					<tr><td>&nbsp;</td></tr>	
																					<tr>
																						<td><s:label value="Electorate" ></s:label></td>
																						<td><s:textfield name="electorate" id="electorate" readonly="true"></s:textfield></td>
																						<td><s:label value="Representative and Contact" ></s:label></td>
																						<td><s:textfield name="representative" id="representative" readonly="true"></s:textfield><s:textfield name="repContact" id="repContact" readonly="true"></s:textfield></td>
																					</tr>	
																					<tr>	
