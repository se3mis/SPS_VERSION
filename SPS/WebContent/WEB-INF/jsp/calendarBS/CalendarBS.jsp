...
<script type="text/javascript" src="../../script/calendarCM.js"></script>
<s:head  />
<sx:head />
				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="scheduleCMBS" method="POST" theme="simple">
													...
													<table width="100%" height="50%" class="tblContent" border="0"  >
														...
														<tbody>
															<tr>
																...
																<table width="100%" border="0" align="center"  cellpadding="0" cellspacing="0" class="tldFromContent" style="border-collapse:collapse"  >
																	<tr>
																		<td class="divTex"> 
																	...
																	<tr>																																									
																			<td align="left" class="divTex">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:label value="Selected Date" ></s:label></td>
																	...
																	<tr>																																									
																			<td class="divTex" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:label value="dd/mm/yyyy" ></s:label></td>
				                                                                        ...
				                                                                        <td align="center" class="listHeader">Diary Schedules
				                                                                                ...
				                                                                                <table id="list_table" width="95%" align="center" border="1" style="border-color:#000033;border-collapse:collapse"   >
				                                                                                    <tr class="listColumnHeadingStyle">
				                                                                                    	...
				                                                                                    	<td align="center">Construction Reference</td>
				                                                                                    	<td align="center">Allocated By</td>
				                                                                                    	<td align="center">Allocated To</td>
