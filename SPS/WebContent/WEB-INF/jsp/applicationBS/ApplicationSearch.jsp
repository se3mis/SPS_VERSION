				...
				<tbody>
					...
					<tr>
						...
						<table class="tblContent" border="1" cellpadding="0"
							...
							<tbody>
								<tr>
									<td><s:form action="loadAppSearchPageBS" method="POST"
										...
										<table width="100%" class="tldFromContent" border="0">
											...
											<tr>
												<td>Temp ID (<span class="style1">ABS/ARE/ALN/APL Number</span>)</td>
												<td>:</td>
											...
											<tr>
												<td>Application Number<br />
                                                    (<span class="style1">EBS/ERE/ELN/EPL Number</span>)</td>
												<td>:</td>
												<td><s:textfield id="appName" name="appName" size="20" maxlength="20" ></s:textfield>
												</td>
											</tr>
										
											 <s:if test="%{costCenter=='510.20' || costCenter=='510.30' || costCenter=='530.80' || costCenter=='530.20' || costCenter=='550.30' || costCenter=='550.20' || costCenter=='501.30' || costCenter=='501.20'  || costCenter=='530.30' || costCenter=='530.80' || costCenter=='450.20'  || costCenter=='450.30'  || costCenter=='543.00' || costCenter=='543.10'  || costCenter=='543.20' || costCenter=='543.40' || costCenter=='520.20' || costCenter=='520.30' || costCenter=='540.20' || costCenter=='540.70'
																						|| costCenter=='540.30' || costCenter=='544.10'
																						|| costCenter=='544.21' || costCenter=='544.22'
																						|| costCenter=='544.24' || costCenter=='544.23'
																						|| costCenter=='544.30' || costCenter=='544.31'
																						|| costCenter=='544.32' || costCenter=='545.05'
																						|| costCenter=='545.10' || costCenter=='545.20'
																						|| costCenter=='545.21' || costCenter=='545.22' || costCenter=='545.23'}">
												<tr>
														<td>Estimate Number<br />
	                                                    (<span class="style1">Ex:xxx.xx/12/xxxx</span>)</td>
													<td>:</td>
													<td><s:textfield id="jobNumber" name="jobNumber" size="20" maxlength="20" ></s:textfield>
													</td>
												</tr>
											</s:if>
											<tr>
												<td>File Reference/Code Number</td>
												<td>:</td>
												<td><s:textfield id="fileRef" name="fileRef"
											...
											<tr>
												...
												<table class="tldFromContent" border="1">
													...
													<tr>
														<s:url id="page_url" namespace="/applicationBS/web" action="loadAppStatusPageBS">
