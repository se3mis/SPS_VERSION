...
function printApplication(){
	...
	var fundsource= document.getElementById("foundSource").value;
	var schemaNo= document.getElementById("schemaNo").value;
	...
	var electrate= document.getElementById("electrate").value;
	...
	var gsDivision= document.getElementById("gsDivision").value;
	var agaDivision= document.getElementById("agaDivision").value;
	
	
	var cscname= document.getElementById("cscname").value;
	var district= document.getElementById("district").value;
	var areaCode= document.getElementById("areaName").value;
	var devSec=document.getElementById("devSec").value;
	var district=document.getElementById("district").value;
	...
	document.ApplicationApplet.print( applicationId, applicationType, fundsource, 
			schemaNo, schemaName, date, description, costCentreNo, 
			costCentreName, idType, idNo, firstName, lastName, 
			streetAddress, suburb, city, postalCode, telephoneNo, 
			mobileNo, email, preferefLanguage, cebEmployee, areaCode,             
            serviceStreetAddress, serviceSuburb, serviceCity, servicePostalCode, 
                gsDivision, 
            agaDivision, cscname, electrate,district,  
               preparedBy, confirmedBy);
