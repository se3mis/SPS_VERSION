...
function selectType(){
	if(document.getElementById('txfdApplicationSubType').value=="MT"){
		document.getElementById('txfdApplicationType').value="MT";
		//document.getElementById('txfdApplicationId').value="514.20/AMT/2011/xxxx";
	}else if(document.getElementById('txfdApplicationSubType').value=="SA"){
		document.getElementById('txfdApplicationType').value="SA";
		//document.getElementById('txfdApplicationId').value="514.20/ASA/2011/xxxx";
	}else if(document.getElementById('txfdApplicationSubType').value=="PS"){
		document.getElementById('txfdApplicationType').value="PS";
		//document.getElementById('txfdApplicationId').value="514.20/APS/2011/xxxx";
	}else if(document.getElementById('txfdApplicationSubType').value=="BD"){
		document.getElementById('txfdApplicationType').value="BD";
		//document.getElementById('txfdApplicationId').value="514.20/ABD/2011/xxxx";
	}else{
		document.getElementById('txfdApplicationType').value="MT";
		//document.getElementById('txfdApplicationId').value="514.20/AMT/2011/xxxx";
	}
