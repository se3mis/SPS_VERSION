...
public class Gldeptin implements Serializable {
	...
	public String toString() {
		return "Gldeptin [deptId=" + deptId + ", bankCode=" + bankCode
				+ ", branchCode=" + branchCode + ", bulkSupplierAdd="
				+ bulkSupplierAdd + ", bulkSupplierName=" + bulkSupplierName
				+ ", bulkSupplierTel=" + bulkSupplierTel + ", deptAdd="
				+ deptAdd + ", deptArea=" + deptArea + ", deptFullName="
				+ deptFullName + ", deptProvince=" + deptProvince
				+ ", deptRegion=" + deptRegion + ", deptTel=" + deptTel
				+ ", deptType=" + deptType + ", posA=" + posA + ", posCenter="
				+ posCenter + "]";
	}
