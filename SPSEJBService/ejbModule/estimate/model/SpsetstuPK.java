...
/**
 * The primary key class for the SPSETSTU database table.
 * 
 */
@Embeddable
public class SpsetstuPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SpsetstuPK)) {
			return false;
		}
		SpsetstuPK castOther = (SpsetstuPK)other;
		return 
	...
	public String toString() {
		return "SpsetstuPK [applicationNo=" + applicationNo + ", deptId="
				+ deptId + ", matCd=" + matCd + "]";
	}
}