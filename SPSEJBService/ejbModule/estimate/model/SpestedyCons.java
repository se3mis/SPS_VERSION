...
public class SpestedyCons implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SpestedyConsPK id;
	...
	public SpestedyConsPK getId() {
		return this.id;
	}

	public void setId(SpestedyConsPK id) {
		this.id = id;
	}
	...
	public String toString() {
		return "SpestedyCon [id=" + id + ", allocatedBy=" + allocatedBy
