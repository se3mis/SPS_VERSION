...
/**
 * The primary key class for the SPESTSMT database table.
 * 
 */
@Embeddable
public class SpsetpolPK implements Serializable {
	...
	public String toString() {
		return "SpsetpolPK [applicationNo=" + applicationNo + ", deptId="
				+ deptId + ", pointType=" + pointType + ", poleType="
				+ poleType + ", fromConductor=" + fromConductor
