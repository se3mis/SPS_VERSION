...
public class Spodrcrd implements Serializable {
	...
	public String toString() {
		return "Spodrcrd [id=" + id + ", avgConsump=" + avgConsump
				+ ", connectedDate=" + connectedDate + ", initReading1="
				+ initReading1 + ", initReading2=" + initReading2
				+ ", initReading3=" + initReading3 + ", kvaRating=" + kvaRating
				+ ", meterNo1=" + meterNo1 + ", meterNo2=" + meterNo2
				+ ", meterNo3=" + meterNo3 + ", meterType1=" + meterType1
				+ ", meterType2=" + meterType2 + ", meterType3=" + meterType3
				+ ", noOfDigits1=" + noOfDigits1 + ", noOfDigits2="
				+ noOfDigits2 + ", noOfDigits3=" + noOfDigits3
				+ ", noOfMeters=" + noOfMeters + ", oldAccNo=" + oldAccNo
				+ ", packNo=" + packNo + ", readerCode=" + readerCode
				+ ", updBy=" + updBy + ", updDate=" + updDate + ", walkSeq="
				+ walkSeq + "]";
	}
