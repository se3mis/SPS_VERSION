...
/**
 * The primary key class for the PCTRXDTT database table.
 * 
 */
@Embeddable
public class PctrxdttPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PctrxdttPK)) {
			return false;
		}
		PctrxdttPK castOther = (PctrxdttPK)other;
		return 
