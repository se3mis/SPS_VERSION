...
public class Spestbip implements Serializable {
	...
	public String toString() {
		return "Spestbip [id=" + id + ", billDate=" + billDate
				+ ", billReferenceNo=" + billReferenceNo + ", payAmt=" + payAmt
				+ ", retentionAmt=" + retentionAmt + ", totalBillAmt="
				+ totalBillAmt + ", withholdAmt=" + withholdAmt + "]";
	}
