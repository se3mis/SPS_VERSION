...
/**
 * The primary key class for the PCTRXHMT database table.
 * 
 */
@Embeddable
public class PctrxhmtPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PctrxhmtPK)) {
			return false;
		}
		PctrxhmtPK castOther = (PctrxhmtPK)other;
		return 
