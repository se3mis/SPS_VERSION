...
/**
 * The persistent class for the PCTRXDTT database table.
 * 
 */
@Entity
public class Pctrxdtt implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PctrxdttPK id;
	...
	public PctrxdttPK getId() {
		return this.id;
	}

	public void setId(PctrxdttPK id) {
		this.id = id;
	}
